                                            ...
                                            <div class="card h-100 mb-0">
                                                ...
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="form-check form-switch d-flex gap-2 flex-column p-0 mt-3">
                                                        <label class="form-check-label f-w-600 pl-1"
                                                            for="cust-darklayout-auto">{{ __('Auto Dark Mode') }}</label>
                                                        <input type="checkbox" class="form-check-input mx-0"
                                                            id="cust-darklayout-auto"
                                                            name="cust_darklayout_auto"{{ !empty($settings['cust_darklayout_auto']) && $settings['cust_darklayout_auto'] == 'on' ? 'checked' : '' }} />
                                                    </div>
                        ...
                        {{ Form::close() }}
                         <div class="col-12">
                                        <div class="card h-100 mb-0">
                                            <div class="card-header p-3">
                                                <h6 class="mb-0 d-flex align-items-center gap-2">
                                                    <i data-feather="sliders"></i>{{ __('Module Colors') }}
                                                </h6>
                                            </div>
                                            <div class="card-body p-3">
                                                <div class="row row-gap-2">
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-default">{{ __('Default') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-default" name="module_color_default"
                                                            value="{{ !empty($settings['module_color_default']) ? $settings['module_color_default'] : '#6FD943' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-account">{{ __('Accounting') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-account" name="module_color_account"
                                                            value="{{ !empty($settings['module_color_account']) ? $settings['module_color_account'] : '#4b7bec' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-crm">{{ __('CRM') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-crm" name="module_color_crm"
                                                            value="{{ !empty($settings['module_color_crm']) ? $settings['module_color_crm'] : '#20bf6b' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-hrm">{{ __('HRM') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-hrm" name="module_color_hrm"
                                                            value="{{ !empty($settings['module_color_hrm']) ? $settings['module_color_hrm'] : '#eb3b5a' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-project">{{ __('Projects') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-project" name="module_color_project"
                                                            value="{{ !empty($settings['module_color_project']) ? $settings['module_color_project'] : '#f7b731' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-pos">{{ __('POS') }}</label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-pos" name="module_color_pos"
                                                            value="{{ !empty($settings['module_color_pos']) ? $settings['module_color_pos'] : '#2d98da' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
