    ...
    <div class="navbar-content">
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                <!--------------------- Start Medical ----------------------------------->
                @if (Gate::check('manage patient') || Gate::check('manage medical appointment') || Gate::check('manage lab test catalog') || Gate::check('manage patient lab order'))
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'patients' || Request::segment(1) == 'medical-appointments' || Request::segment(1) == 'lab-test-catalogs' || Request::segment(1) == 'patient-lab-orders' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                        ...
                        <ul class="dash-submenu">
                            ...
                            @endif
                            @if (Gate::check('manage patient lab order'))
                                <li
                                    class="dash-item {{ Request::segment(1) == 'patient-lab-orders' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('patient-lab-orders.index') }}">{{ __('Lab Orders') }}</a>
                                </li>
                            @endif
                            @if (Gate::check('manage lab test catalog'))
                                <li
                                    class="dash-item {{ Request::segment(1) == 'lab-test-catalogs' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('lab-test-catalogs.index') }}">{{ __('Laboratory Catalog') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                    ...
                    @if (Gate::check('manage production'))
                        <li
                            ...
                            <a href="#!" class="dash-link "><span class="dash-micon"><i
                                    ...
                                    class="dash-mtext">{{ __('Production') }}</span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu {{ Request::segment(1) == 'production' ? 'show' : '' }}">
                                <li class="dash-item {{ Request::route()->getName() == 'production.orders.index' ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('production.orders.index') }}">{{ __('Production Orders') }}</a>
                                </li>
                                <li class="dash-item {{ Request::route()->getName() == 'production.boms.index' ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('production.boms.index') }}">{{ __('Bill of Materials') }}</a>
                                </li>
                    ...
                    @if (Gate::check('manage company plan') || Gate::check('manage order') || Gate::check('manage company settings'))
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @endif
                                <li class="dash-item {{ Request::segment(1) == 'integrations' ? ' active' : '' }}">
                                    <a href="{{ route('integrations.index') }}"
                                        class="dash-link">{{ __('Integrations') }}</a>
                                </li>
                                <li class="dash-item {{ Request::segment(1) == 'workflows' ? ' active' : '' }}">
