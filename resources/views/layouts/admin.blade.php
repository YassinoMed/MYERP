...
<meta name="global-search-url" content="{{ route('global.search') }}">
<meta name="notifications-panel-url" content="{{ route('notifications.panel') }}">
<meta name="notifications-read-all-url" content="{{ route('notifications.read.all') }}">
<meta name="notifications-read-url-template" content="{{ route('notifications.read', ['notification' => 0]) }}">
<meta name="audit-log-feed-url" content="{{ route('audit.log.feed') }}">
...
<head>
    ...
    <link rel="stylesheet" href="{{ $setting['cust_darklayout'] == 'on' ? $darkStyle : $lightStyle }}" id="main-style-link" data-light="{{ $lightStyle }}" data-dark="{{ $darkStyle }}">

    <link rel="stylesheet" href="{{ asset('assets/css/customizer.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}">
    <link rel="stylesheet" href="{{ asset('css/ux-enhancements.css') }}">

    <link rel="stylesheet" href="{{ asset('css/custom-dark.css') }}" id="custom-dark-link" {{ $setting['cust_darklayout'] == 'on' ? '' : 'disabled' }}>
