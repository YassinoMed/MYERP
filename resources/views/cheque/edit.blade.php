{{ Form::model($cheque, ['route' => ['cheques.update', $cheque->id], 'method' => 'put', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="form-group">
                ...
                {{ Form::date('issue_date', $cheque->issue_date, ['class' => 'form-control', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="form-group">
                {{ Form::label('due_date', __('Due Date'), ['class' => 'form-label']) }}
                {{ Form::date('due_date', $cheque->due_date, ['class' => 'form-control']) }}
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="form-group">
                ...
                {{ Form::select('status', ['issued' => __('Issued'), 'deposited' => __('Deposited'), 'cleared' => __('Cleared'), 'bounced' => __('Bounced'), 'canceled' => __('Canceled')], $cheque->status, ['class' => 'form-control', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="form-group">
                {{ Form::label('status_date', __('Status Date'), ['class' => 'form-label']) }}
                {{ Form::date('status_date', $cheque->status_date, ['class' => 'form-control']) }}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
