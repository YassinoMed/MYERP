...
<head>
    <title><?php echo e($setting['title_text'] ? $setting['title_text'] : config('app.name', 'ERPGo SaaS')); ?></title>
    <!-- Meta -->
    <meta charset="utf-8" />
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($sup_logo . '/' . $adminSettings['company_favicon'] . '?' . time()); ?>" type="image/x-icon" />
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="card price-card shadow-none <?php echo e($key == 2 ? 'bg-dark' : ''); ?>">
                                <div class="card-body">
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    ...
                                                    <span class="me-2"><i
                                                        class="text-primary ti ti-circle-plus fs-4"></i></span>
                                                        <?php echo e($value->max_customers == -1 ? 'Unlimited' : $value->max_customers); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    ...
                                                    <span class="me-2"><i
                                                        class="text-primary ti ti-circle-plus fs-4"></i></span>
                                                        <?php echo e($value->max_venders == -1 ? 'Unlimited' : $value->max_venders); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    ...
                                                    <span class="me-2"><i
                                                        class="text-primary ti ti-circle-plus fs-4"></i></span>
                                                        <?php echo e($value->max_clients == -1 ? 'Unlimited' : $value->max_clients); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->account == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->account == 1 ? 'Enable' : 'Disable'); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->crm == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->crm == 1 ? 'Enable' : 'Disable'); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->hrm == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->hrm == 1 ? 'Enable' : 'Disable'); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->project == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->project == 1 ? 'Enable' : 'Disable'); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->pos == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->pos == 1 ? 'Enable' : 'Disable'); ?>
                                        ...
                                        <li>
                                            <div class="form-check text-start">
                                                <label class="form-check-label d-flex align-items-center"
                                                    for="customCheckc1">
                                                    <span class="me-2"><i
                                                        class="ti <?php echo e($value->chatgpt == 1 ? 'ti-circle-plus text-primary' : 'ti-circle-minus text-danger'); ?> fs-4"></i></span>
                                                        <?php echo e($value->chatgpt == 1 ? 'Enable' : 'Disable'); ?>
                                    ...
                                    <div class="d-grid">
                                        <a href="<?php echo e(Auth::check() ? route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($value->id)) : route('register', ['plan' => \Illuminate\Support\Facades\Crypt::encrypt($value->id)])); ?>"
                                            class="btn btn-primary rounded-pill"><?php echo e(__('Start with ') . ucfirst($value->name)); ?> <i
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>