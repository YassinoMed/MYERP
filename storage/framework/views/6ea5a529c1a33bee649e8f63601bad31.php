...
<div class="quotation-preview-main" id="boxes">
    <div class="quotation-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?> "><?php echo e(__('quotation')); ?></h3>
                    ...
                    <table class="no-space">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo e(Utility::dateFormat($settings,$quotation->quotation_date)); ?></td>
                        </tr>
                ...
                <td class="text-right">
                    <img class="quotation-logo"  src="<?php echo e($img); ?>"
                         alt="">
                    <p>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('quotation.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>;
<?php endif; ?>

</body>

</html>
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/quotation/templates/template5.blade.php ENDPATH**/ ?>