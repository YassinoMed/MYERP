...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end me-2">
        ...
        <button type="submit" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>"
    ...
    <div class="float-end me-2" id="filter">
        <button id="filter" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="<?php echo e(__('Filter')); ?>" data-original-title="<?php echo e(__('Filter')); ?>"><i class="ti ti-filter"></i></button>
    </div>

    <div class="float-end me-2">
        <a href="<?php echo e(route('report.balance.sheet', 'vertical')); ?>" class="btn btn-sm bg-light-blue-subtitle" data-bs-toggle="tooltip"
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5><?php echo e('Balance Sheet of ' . Auth::user()->name . ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>
                                            ...
                                            <div class="account-main-inner py-2">
                                                ...
                                                <div class="border-bottom py-2">
                                                    <p class="fw-bold ps-4 mb-2">
                                                        <?php echo e((isset($account['subType']) && $account['subType'] == true) ? $account['subType'] : ''); ?>
                                                    ...
                                                    <?php $__currentLoopData = $account['account']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $records): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <?php if(($key < count($account['account']) - 1 && $record['account'] == '') || $record['account'] != 'subAccount'): ?>
                                                                        <?php if(
                                                                            ...
                                                                            <div
                                                                                class="account-inner d-flex align-items-center justify-content-between ps-md-5 ps-3">
                                                                                <p class="mb-2 ms-3">
                                                                                <?php if($record['account_name'] == 'Current Year Earnings'): ?>
                                                                                    <a
                                                                                        href="<?php echo e(route('report.profit.loss')); ?>"
                                                            ...
                                                            <?php else: ?>
                                                                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <?php if(($key < count($account['account']) - 1 && $record['account'] == '') || $record['account'] == 'subAccount' || $record['account_name'] == 'Current Year Earnings'): ?>
                                                                        <?php if(
                                                                            (!preg_match('/\btotal\b/i', $record['account_name']) && $record['account'] == '') ||
                                                                                $record['account'] == 'subAccount'): ?>
                                                                            <div
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/balance_sheet_horizontal.blade.php ENDPATH**/ ?>