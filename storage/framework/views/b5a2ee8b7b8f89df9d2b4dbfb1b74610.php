...
<div class="invoice-preview-main" id="boxes">
    <div class="invoice-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?> "><?php echo e(__('INVOICE')); ?></h3>
                ...
                <td class="text-right">
                    <img class="invoice-logo"  src="<?php echo e($img); ?>"
                         alt="">
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/invoice/templates/template5.blade.php ENDPATH**/ ?>