...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end me-2">
        <a href="<?php echo e(route('report.balance.sheet', 'horizontal')); ?>" class="btn btn-sm bg-light-blue-subtitle" data-bs-toggle="tooltip"
        ...
        <div class="row justify-content-center" id="printableArea">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body <?php echo e($collapseview == 'expand' ? 'collapse-view' : ''); ?> overflow-auto">
                        ...
                        <?php $__currentLoopData = $totalAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $accounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="account-main-inner py-2">
                                    <?php if(($type == 'Liabilities' || $type == 'Equity') && $show == ''): ?>
                                    ...
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="border-bottom py-2">
                                            <p class="fw-bold ps-md-4 ps-3 mb-2">
                                                <?php echo e((isset($account['subType']) && $account['subType'] == true) ? $account['subType'] : ''); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/balance_sheet.blade.php ENDPATH**/ ?>