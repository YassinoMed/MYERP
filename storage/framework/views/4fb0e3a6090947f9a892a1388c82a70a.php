...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-sm-12">
                        ...
                        <div class="deals-card-inner d-flex align-items-center gap-3">
                            ...
                            <div class="deals-content d-flex align-items-start gap-2 justify-content-between flex-1">
                                <div class="deals-content-inner">
                                    ...
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('deals.index')); ?>"
                                            class="dashboard-link"><?php echo e(__('Deal')); ?></a></h2>
                                </div>
                                <h3 class="h4 m-0"><?php echo e($arrCount['deal']); ?></h3>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-lg-6 col-md-6 deals-card">
                        <div class="deals-card-inner d-flex align-items-center gap-3">
                            ...
                            <div class="deals-content d-flex align-items-start gap-2 justify-content-between flex-1">
                                <div class="deals-content-inner">
                                    <span class="text-sm d-block mb-1"><?php echo e(__('Total')); ?></span>
                                    <h2 class="h4 m-0"><?php echo e(__('Deal Task')); ?></h2>
                                </div>
                                <h3 class="h4 m-0"><?php echo e($arrCount['task']); ?></h3>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                                ...
                                <div class="row gy-3">
                                    <div class="col-md-4 col-sm-6 total-client-card">
                                        <div class="client-card-content d-flex align-items-center gap-2 mb-3">
                                            <p class="mb-0"><?php echo e(__('Total Project')); ?></p>
                                            <h3 class="mb-0 h4"><?php echo e($project['project_percentage']); ?>%</h3>
                                        </div>
                                        <div class="progress mb-0">
                                            <div class="progress-bar"
                                                style="width: <?php echo e($project['project_percentage']); ?>%;"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 total-client-card">
                                        <div class="client-card-content d-flex align-items-center gap-2 mb-3">
                                            <p class="mb-0"><?php echo e(__('Total Project Tasks')); ?></p>
                                            <h3 class="mb-0 h4"><?php echo e($project['projects_tasks_count']); ?>%</h3>
                                        </div>
                                        <div class="progress mb-0">
                                    ...
                                    <div class="col-md-4 col-sm-6 total-client-card">
                                        <div class="client-card-content d-flex align-items-center gap-2 mb-3">
                                            <p class="mb-0"><?php echo e(__('Total Bugs')); ?></p>
                                            <h3 class="mb-0 h4"><?php echo e($project['projects_bugs_count']); ?>%</h3>
                                        </div>
                                        <div class="progress mb-0">
                                            <div class="progress-bar bg-<?php echo e($label1); ?>"
                    ...
                    <div class="col-xxl-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                ...
                                <h6 class="last-day-text mb-0"><?php echo e(__('Last 7 Days')); ?></h6>
                            </div>
                            <div class="card-body">
        ...
        <div class="row">
            <div
                class="<?php echo e(Auth::user()->type == 'company' || Auth::user()->type == 'client' ? 'col-xl-6 col-lg-6 col-md-6' : 'col-xl-8 col-lg-8 col-md-8'); ?> col-sm-12">
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody class="list">
                                    <?php $__empty_2 = true; $__currentLoopData = $project['projects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <?php
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $top_tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $top_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <tr>
                                            <td class="id-web">
                                                                ...
                                                                <?php if($key < 3): ?>
                                                                    <a href="#"
                                                                        ...
                                                                        <img data-original-title="<?php echo e(!empty($user) ? $user->name : ''); ?>"
                                                                            <?php if($user->avatar): ?> src="<?php echo e(asset('/storage/uploads/avatar/' . $user->avatar)); ?>" <?php else: ?> src="<?php echo e(asset('assets/img/avatar/avatar-1.png')); ?>" <?php endif; ?>
                                            ...
                                            <td><span
                                                    class="p-2 px-3 rounded status_badge badge bg-"><?php echo e($top_task->stage->name); ?></span>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                        <tr class="text-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/clientView.blade.php ENDPATH**/ ?>