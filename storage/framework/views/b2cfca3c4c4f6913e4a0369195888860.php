                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show appraisal')): ?>
                                                <div class="action-btn me-2">
                                                    <a href="#" data-url="<?php echo e(route('appraisal.show',$appraisal->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Appraisal Detail')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>" data-original-title="<?php echo e(__('View Detail')); ?>" class="mx-3 btn btn-sm align-items-center bg-warning">
                                                        <i class="ti ti-eye text-white"></i></a>
                                                </div>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit appraisal')): ?>
                                                <div class="action-btn me-2">
                                                    <a href="#" data-url="<?php echo e(route('appraisal.edit',$appraisal->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Appraisal')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>" class="mx-3 btn btn-sm align-items-center bg-info">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/appraisal/index.blade.php ENDPATH**/ ?>