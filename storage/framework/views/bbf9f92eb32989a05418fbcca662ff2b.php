<?php echo e(Form::open(['url' => 'cap-table', 'method' => 'post', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::select('holder_type', $holderTypes, 'individual', ['class' => 'form-control select', 'required' => 'required'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::number('share_count', 0, ['class' => 'form-control', 'step' => '0.0001', 'required' => 'required'])); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('issue_price', 0, ['class' => 'form-control', 'step' => '0.0001'])); ?>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <?php echo e(Form::number('ownership_percentage', 0, ['class' => 'form-control', 'step' => '0.0001'])); ?>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <?php echo e(Form::number('voting_percentage', 0, ['class' => 'form-control', 'step' => '0.0001'])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/cap_table/create.blade.php ENDPATH**/ ?>