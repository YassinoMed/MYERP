...
<div class="bill-preview-main" id="boxes">
    <div class="bill-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?> "><?php echo e(__('BILL')); ?></h3>
                ...
                <td class="text-right">
                    <img class="bill-logo"  src="<?php echo e($img); ?>"
                         alt="">
                    <p>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('bill.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>;
<?php endif; ?>

</body>

</html>
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/bill/templates/template5.blade.php ENDPATH**/ ?>