                ...
                <div class="warehouse-card-inner">
                    ...
                    <div class="info-wrp d-flex align-items-center justify-content-between gap-3 ">
                        <div class="info-wrp-inner d-flex align-items-center gap-3">
                            ...
                            <h2 class="h4 mb-0"><?php echo e(__('Warehouse Report')); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="warehouse-card-inner">
                    ...
                    <div class="info-wrp d-flex align-items-center justify-content-between gap-3 ">
                        <div class="info-wrp-inner d-flex align-items-center gap-3">
                            ...
                            <h2 class="h4 mb-0"><?php echo e(__('Total Warehouse')); ?>:</h2>
                        </div>
                        <h4 class="mb-0"><?php echo e($totalWarehouse); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-sm-6 col-12 warehouse-card">
                <div class="warehouse-card-inner">
                    ...
                    <div class="info-wrp d-flex align-items-center justify-content-between gap-3 ">
                        <div class="info-wrp-inner d-flex align-items-center gap-3">
                            ...
                            <h2 class="h4 mb-0"><?php echo e(__('Total Product')); ?>:</h2>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/warehouse.blade.php ENDPATH**/ ?>