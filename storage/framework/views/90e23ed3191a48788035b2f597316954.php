...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        (function () {
            var mainRow = document.getElementById('account-dashboard-main-row');
            if (!mainRow || typeof dragula === 'undefined') {
                return;
            }

            var storedLayout = <?php echo json_encode($dashboardLayout ?? [], 15, 512) ?>;
            if (Array.isArray(storedLayout) && storedLayout.length) {
                storedLayout.forEach(function (widgetId) {
                    var element = mainRow.querySelector('.dashboard-widget[data-widget="' + widgetId + '"]');
                    if (element) {
            ...
            var drake = dragula([mainRow]);
            var isSaving = false;

            function getLayout() {
                return Array.prototype.slice.call(mainRow.querySelectorAll('.dashboard-widget')).map(function (el) {
            ...
            function saveLayout() {
                ...
                isSaving = true;
                $.ajax({
                    url: '<?php echo e(route('dashboard.layout.save')); ?>',
                    type: 'POST',
                    data: {
                        dashboard: 'account',
                        layout: {
...
<?php $__env->startSection('page-subtitle'); ?>
    <?php echo e(__('Follow revenue, expenses, cash posture and the most recent billing movements from one finance-first dashboard.')); ?>
        ...
        <div class="col-sm-12">
            <?php if(!empty($executiveSummary)): ?>
                <div class="ux-kpi-grid mb-4">
                    <?php $__currentLoopData = $executiveSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row" id="account-dashboard-main-row">
                        ...
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e($constant['taxes'] ?? 0); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('taxes.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Taxes')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e($constant['category'] ?? 0); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('product-category.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Categories')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e($constant['units'] ?? 0); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('product-unit.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Units')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0"><?php echo e($constant['bankAccount'] ?? 0); ?></h3>
                                </div>
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="<?php echo e(route('bank-account.index')); ?>"
                                            class="info-link dashboard-link"><?php echo e(__('Total Bank Accounts')); ?></a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $bankAccountDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-income-expense">
                ...
                <div class="col-xxl-7 dashboard-widget" data-widget="account-income-expense-chart">
                    <div class="card">
                        <div class="card-header">
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-income-category">
                ...
                <div class="col-xxl-7 dashboard-widget" data-widget="account-latest-income">
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $latestIncome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <tr>
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-expense-category">
                    <div class="card" style="height: 370px">
                        <div class="card-header">
                ...
                <div class="col-xxl-7 dashboard-widget" data-widget="account-latest-expense">
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $latestExpense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-storage">
                    <div class="card" style="height: 370px">
                        <div class="card-header">
                ...
                <div class="col-xxl-7 dashboard-widget" data-widget="account-recent-invoices">
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $recentInvoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <tr>
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-invoice-stats">
                ...
                <div class="col-xxl-7 dashboard-widget" data-widget="account-recent-bills">
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_2 = true; $__currentLoopData = $recentBill; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        <tr>
                ...
                <div class="col-xxl-5 dashboard-widget" data-widget="account-bill-stats">
                    <div class="card" style="height: 395px">
                        <div class="card-body">
                            <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                <li class="nav-item">
                ...
                <div class="col-xxl-12 dashboard-widget" data-widget="account-goals">
                    <div class="card">
                        <div class="card-header">
                            <h5><?php echo e(__('Goal')); ?></h5>
                        </div>
                        <div class="card-body">
                            <?php $__empty_2 = true; $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <?php
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>