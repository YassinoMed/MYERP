...
<?php $__env->stopPush(); ?>
<?php if(isset($call)): ?>
    <?php echo e(Form::model($call, array('route' => array('deals.calls.update', $deal->id, $call->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate'))); ?>

<?php else: ?>
    <?php echo e(Form::open(array('route' => ['deals.calls.store',$deal->id], 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
            <?php echo e(Form::text('subject', null, array('class' => 'form-control','required'=>'required', 'placeholder'=>__('Enter Name')))); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/deals/calls.blade.php ENDPATH**/ ?>