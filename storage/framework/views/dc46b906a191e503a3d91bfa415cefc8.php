                            ...
                            <div class="card-body">
                                <div class="row align-items-center mb-2">
                                    ...
                                    <div class="col-6 text-end">
                                        <?php if(str_replace('%','',$task->taskProgress($task)['percentage']) > 0): ?><span class="text-sm"><?php echo e($task->taskProgress($task)['percentage']); ?></span><?php endif; ?>
                                    </div>
                                </div>
                                <?php if(isset($permissions) && in_array('show task',$permissions)): ?>
                                    <a class="h6 task-name-break" href="<?php echo e(route('projects.tasks.index',$task->project->id)); ?>"><?php echo e($task->name); ?></a>
                                <?php else: ?>
                                    <a class="h6 task-name-break" href="#"><?php echo e($task->name); ?></a>
                                <?php endif; ?>
                                    ...
                                    <div class="col-12">
                                        <div class="actions d-inline-block">
                                            ...
                                            <?php if(count($task->comments) > 0): ?>
                                                <div class="action-item mr-2"><i class="ti ti-brand-hipchart mr-2"></i><?php echo e(count($task->comments)); ?></div><?php endif; ?>
                                            <?php if($task->checklist->count() > 0): ?>
                                                <div class="action-item mr-2"><i class="ti ti-tasks mr-2"></i><?php echo e($task->countTaskChecklist()); ?></div><?php endif; ?>
                                        </div>
                                    </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/tasks/grid.blade.php ENDPATH**/ ?>