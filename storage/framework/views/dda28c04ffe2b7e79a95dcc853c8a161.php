<?php echo e(Form::open(['url' => route('production.resources.store'), 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
            <?php echo e(Form::select('type', ['site' => __('Site'), 'workshop' => __('Workshop'), 'line' => __('Line'), 'station' => __('Station')], 'site', ['class' => 'form-control'])); ?>
...
<?php endif; ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('status', ['active' => __('Active'), 'inactive' => __('Inactive'), 'maintenance' => __('Maintenance')], 'active', ['class' => 'form-control'])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/production/industrial_resources/create.blade.php ENDPATH**/ ?>