<?php echo e(Form::open(['url' => 'production/orders', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('quantity_planned', __('Planned Quantity'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::number('quantity_planned', 1, ['class' => 'form-control', 'required' => 'required', 'step' => '0.0001', 'min' => 0.0001])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('priority', ['low' => __('Low'), 'normal' => __('Normal'), 'high' => __('High'), 'urgent' => __('Urgent')], 'normal', ['class' => 'form-control', 'required' => 'required'])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('planned_machine_hours', __('Planned Machine Hours'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('planned_machine_hours', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('planned_labor_hours', __('Planned Labor Hours'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('planned_labor_hours', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('planned_start_date', __('Planned Start Date'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::date('planned_start_date', null, ['class' => 'form-control'])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('planned_end_date', __('Planned End Date'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::date('planned_end_date', null, ['class' => 'form-control'])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/production/orders/create.blade.php ENDPATH**/ ?>