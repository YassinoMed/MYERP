                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid <?php echo e($color); ?>;">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-3"><h1 data-v-4b3dcb8a="" class="fancy-title mb5"><?php echo e(__('ESTIMATION')); ?></h1></div>
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            ...
                                            <strong data-v-4b3dcb8a="" class="sub-title"><?php echo e($client->name); ?></strong>
                                            <pre data-v-4b3dcb8a=""><?php echo e($client->email); ?></pre>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb"><?php echo e(__('Number')); ?>:</td>
                                                <td data-v-4b3dcb8a="" class="text-end"><?php echo e($usr->estimateNumberFormat($estimation->estimation_id)); ?></td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb"><?php echo e(__('Issue Date')); ?>:</td>
                                                <td data-v-4b3dcb8a="" class="text-end"><?php echo e($usr->dateFormat($estimation->issue_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-4b3dcb8a="" class="d-table">
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="tu d-table-tr" style="background: <?php echo e($color); ?>; padding: 5px;color: <?php echo e($font_color); ?>">
                                            <div data-v-4b3dcb8a="" class="d-table-th w-2"><?php echo e(__('#')); ?></div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-13"><?php echo e(__('Item description')); ?></div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-3"><?php echo e(__('Price')); ?></div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-2"><?php echo e(__('Qty')); ?></div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-3 text-end"><?php echo e(__('Amount')); ?></div>
                                        </div>
                                        <div data-v-4b3dcb8a="" class="d-table-body">
                                            <?php if(isset($estimation->getProducts) && count($estimation->getProducts) > 0): ?>
                                                <?php $__currentLoopData = $estimation->getProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-2"><span><?php echo e($key+1); ?></span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-13">
                                                            <pre data-v-4b3dcb8a=""><?php echo e($item->name); ?><br data-v-4b3dcb8a=""></pre>
                                                        </div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3"><span data-v-4b3dcb8a=""><?php echo e($usr->priceFormat($item->pivot->price)); ?></span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-2"><span data-v-4b3dcb8a=""><?php echo e($item->pivot->quantity); ?></span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-end"><span data-v-4b3dcb8a=""><?php echo e($usr->priceFormat($item->pivot->price * $item->pivot->quantity)); ?></span></div>
                                                    </div>
                                            ...
                                            <?php else: ?>
                                                <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-td w-2"><span data-v-4b3dcb8a="">-</span></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-td w-3 text-end"><span data-v-4b3dcb8a="">-</span></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><?php echo e(__('Sub Total')); ?>:</div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal())); ?></div>
                                                </div>

                                                <?php if($estimation->discount): ?>
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->discount)); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($estimation->getTax()): ?>
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label"><?php echo e($estimation->tax->name); ?> (<?php echo e($estimation->tax->rate); ?>%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getTax())); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a=""><?php echo e(__('Total')); ?>:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a=""><?php echo e($usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())); ?></strong></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/estimations/templates/template6.blade.php ENDPATH**/ ?>