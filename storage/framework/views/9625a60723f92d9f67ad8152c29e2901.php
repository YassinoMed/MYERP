    ...
    <ul class="nav nav-ul nav-pills my-3" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link" id="pills-home-tab" data-bs-toggle="pill"
               href="<?php echo e(route('report.daily.purchase')); ?>"
               onclick="window.location.href = '<?php echo e(route('report.daily.purchase')); ?>'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " >
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['report.monthly.purchase'], 'method' => 'GET', 'id' => 'monthly_purchase_report_submit'])); ?>
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="<?php echo e(route('report.monthly.purchase')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Monthly Purchase Report')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col mb-4">
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                <h5 class="mb-1"><?php echo e(__('Warehouse')); ?></h5>
                                <p class="text-muted mb-0"><?php echo e($filter['warehouse']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <p class="text-muted mb-0"><?php echo e($filter['vendor']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e($filter['startMonth'].' to '.$filter['endMonth']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/monthly_purchase.blade.php ENDPATH**/ ?>