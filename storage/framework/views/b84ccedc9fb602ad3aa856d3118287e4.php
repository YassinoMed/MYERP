<?php echo e(Form::open(['url' => 'visitors', 'method' => 'post', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?><?php echo e(Form::text('visitor_name', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        ...
        <div class="col-md-6"><div class="form-group"><?php echo e(Form::label('host_employee_id', __('Host Employee'), ['class' => 'form-label'])); ?><?php echo e(Form::select('host_employee_id', $employees, null, ['class' => 'form-control select'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::date('visit_date', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        <div class="col-md-3"><div class="form-group"><?php echo e(Form::label('visit_time', __('Visit Time'), ['class' => 'form-label'])); ?><?php echo e(Form::time('visit_time', null, ['class' => 'form-control'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::select('status', $statuses, 'expected', ['class' => 'form-control select', 'required' => 'required'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/visitors/create.blade.php ENDPATH**/ ?>