                    ...
                    <div class="sticky-top" style="top:30px">
                        <div class="mt-5">
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                style="
                                                                      ...
                                                                      ">
                                <div class="card-body">
                                    <span class="price-badge status_badge bg-primary"><?php echo e($plan->name); ?></span>
                                    <h3 class="mb-4 f-w-600  ">
                                        <?php echo e(isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e($plan->price . ' / ' . __(\App\Models\Plan::$arrDuration[strtolower((string) $plan->duration)] ?? $plan->duration)); ?></small>
                                        </small>
                                    </h3>
                        ...
                        <div class="card ">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                ...
                                <?php endif; ?>
                                <?php if(isset($admin_payment_setting['khalti_payment_is_on']) && $admin_payment_setting['khalti_payment_is_on'] == 'on'): ?>
                                ...
                                <?php endif; ?>
                                <?php if(isset($admin_payment_setting['easebuzz_payment_is_on']) && $admin_payment_setting['easebuzz_payment_is_on'] == 'on'): ?>
                                <a href="#easebuzz_payment"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('Easebuzz')); ?>
                        ...
                        <?php if(isset($admin_payment_setting['khalti_payment_is_on']) && $admin_payment_setting['khalti_payment_is_on'] == 'on'): ?>
                            <div id="khalti_payment" class="card">
                                ...
                                <div class="tab-pane" id="khalti_payment">
                                    <form role="form" action="<?php echo e(route('plan.pay.with.khalti', $plan->id)); ?>"
                        ...
                        <?php if(isset($admin_payment_setting['easebuzz_payment_is_on']) && $admin_payment_setting['easebuzz_payment_is_on'] == 'on'): ?>
                           <div id="easebuzz_payment" class="card">
                               ...
                               <div class="tab-pane" id="easebuzz_payment">
                                   <form role="form" action="<?php echo e(route('plan.pay.with.easebuzz', $plan->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/stripe.blade.php ENDPATH**/ ?>