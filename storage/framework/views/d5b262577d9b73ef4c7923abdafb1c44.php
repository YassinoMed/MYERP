            ...
            var $repeater = $(selector + ' .repeater').repeater({
                ...
                hide: function (deleteElement) {
                    ...
                    if (confirm('Are you sure you want to delete this element?')) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('quotation.product.destroy')); ?>',
                            type: 'POST',
                            headers: {
        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('quotation.items')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12 mb-3">
            <div id="collab-indicator" class="collab-indicator" data-collab-resource="quotation" data-collab-id="<?php echo e($quotation->id); ?>" data-collab-label="<?php echo e($quotation_number); ?>"></div>
        </div>

        <?php echo e(Form::model($quotation, array('route' => array('quotation.update', $quotation->id), 'method' => 'PUT','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
                                <?php echo e(Form::text('customer_id', $customer->name ?? '-', array('class' => 'form-control select','id'=>'vender','required'=>'required', 'readonly' => 'readonly'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <?php echo e(Form::label('warehouse_id', __('Warehouse'),['class'=>'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                    <?php echo e(Form::text('warehouse_id', $warehouse->name, array('class' => 'form-control select','required'=>'required', 'readonly' => 'readonly'))); ?>

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('quotation_date', __('Quotation Date'),['class'=>'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                    <?php echo e(Form::date('quotation_date',null,array('class'=>'form-control','required'=>'required', 'readonly' => 'readonly'))); ?>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='<?php echo e(json_encode($quotation->items)); ?>'>
                ...
                <div class="card-body table-border-style ">
                    <div class="table-responsive">
                        <table class="table  mb-0" data-repeater-list="items" id="sortable-table">
                            <thead>
                            <tr>
                                <th><?php echo e(__('Items')); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></th>
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <div class="form-group">
                                        <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>route('quotation.product'), 'required' => 'requiredwarehouse-transfer'))); ?>

                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::number('quantity',null, array('class' => 'form-control quantity','required'=>'required','placeholder'=>__('Qty'),'required'=>'required'))); ?>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::number('price',null, array('class' => 'form-control price','required'=>'required','placeholder'=>__('Price'),'required'=>'required'))); ?>
                                ...
                                <td>
                                    ...
                                    <div class="action-btn me-2">
                                        <a href="#" class="ti ti-trash text-white btn btn-sm repeater-action-btn bg-danger ms-2 bs-pass-para" data-repeater-delete data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>"></a>
                                    </div>
                                    <?php endif; ?>
                                </td>
                            </tr>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("quotation.index")); ?>';" class="btn btn-secondary me-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/quotation/edit.blade.php ENDPATH**/ ?>