...
<div class="bill-preview-main" id="boxes">
    <div class="bill-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px; color: <?php echo e($color); ?>;"><?php echo e(__('BILL')); ?></h3>
                    <p>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/bill/templates/template4.blade.php ENDPATH**/ ?>