<?php echo e(Form::open(array('route' => array('bill.debit.storenote',$bill_id),'mothod'=>'post', 'class'=>'needs-validation', 'novalidate'))); ?>
            ...
            <div class="form-icon-user">
                <select class="form-control select" required="required" id="debit_note" name="debit_note">
                    ...
                    <?php $__currentLoopData = $debitNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $debitNote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"><?php echo e(\App\Models\CustomerDebitNotes::debitNumberFormat($debitNote)); ?></option>
...
</script><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/debitNote/create.blade.php ENDPATH**/ ?>