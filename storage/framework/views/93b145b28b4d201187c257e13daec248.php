...
<div class="pt-0 pb-3 modal-body pos-module" id="printarea" >
    <table class="table pos-module-tbl">
        <tbody>
            ...
            <div>
                <?php echo isset($details['customer']['name']) ? __('Name').':  ' . $details['customer']['name'] : ''; ?>

            </div>
            <div>
                <?php echo isset($details['customer']['address']) ? __('Address').':  ' . $details['customer']['address'] : ''; ?>

            </div>
            <div>
                <?php echo isset($details['customer']['email']) ? __('Email').':  ' . $details['customer']['email'] : ''; ?>

            </div>
            <div>
                <?php echo isset($details['customer']['phone_number']) ? __('Phone').':  ' . $details['customer']['phone_number'] : ''; ?>

            </div>
            <div>
                <?php echo isset($details['date']) ? __('Date of POS').':  ' . $details['date'] : ''; ?>

            </div>
            <div class="product-border">
                <?php echo isset($details['warehouse']['details']) ? __('Warehouse Name').':  ' . $details['warehouse']['details'] : ''; ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/printview.blade.php ENDPATH**/ ?>