...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($invoice, array('route' => array('invoice.update', $invoice->id), 'method' => 'PUT','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='<?php echo e(json_encode($invoice->items)); ?>'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btn me-2">
                                        <a href="#" class="ti ti-trash text-white btn btn-sm repeater-action-btn bg-danger ms-2  delete_item" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-repeater-delete></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/invoice/edit.blade.php ENDPATH**/ ?>