    ...
    <div class="row">
        <div class="col-12 mb-2" id="getkeywords">
            <div class="form-group" id="getkeywords">
                <textarea class="form-control form-control-light mt-2" id="description" rows="3" name="description" placeholder="<?php echo e(__('Description')); ?>"></textarea>
            </div>
        </div>
    </div>
</form>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/template/grammar_ai.blade.php ENDPATH**/ ?>