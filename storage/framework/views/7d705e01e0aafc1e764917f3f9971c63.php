            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3 flex-wrap justify-content-between">
                        <h4 class="mb-0"><?php echo e(__('POS')); ?></h4>
                        <h4 class="invoice-number mb-0"><?php echo e(Auth::user()->posNumberFormat($pos->pos_id)); ?></h4>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-5">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/view.blade.php ENDPATH**/ ?>