<?php echo e(Form::open(['route' => 'hospital-rooms.store', 'method' => 'post'])); ?>
...
<div class="modal-body"><div class="row">
    ...
    <div class="col-md-6 mt-2"><?php echo e(Form::label('status', __('Status'), ['class' => 'form-label'])); ?><?php echo e(Form::select('status', ['available' => __('Available'), 'maintenance' => __('Maintenance')], 'available', ['class' => 'form-control'])); ?></div>
</div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/hospital_room/create.blade.php ENDPATH**/ ?>