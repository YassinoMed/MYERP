            ...
            <section class="placedjob-section">
                <div class="container">
                    <div class="section-title">
                        ...
                        <p class="mb-0"><?php echo e(__('Always looking for better ways to do things, innovate')); ?> <br>
                                ...
                                <div class="job-card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-1 align-items-center">
                                        <?php $__currentLoopData = explode(',', $job->skill); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge border-primary border rounded p-2"><?php echo e($skill); ?></span>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/job/career.blade.php ENDPATH**/ ?>