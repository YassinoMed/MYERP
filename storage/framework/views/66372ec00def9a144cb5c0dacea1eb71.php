                        ...
                        <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: <?php echo e($color); ?>;color: <?php echo e($font_color); ?>"><?php echo e(__('ESTIMATION')); ?></h1></div>
                                ...
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><strong data-v-e23d9750="" class="tu mb5"><?php echo e(__('Bill To')); ?>:</strong>
                                        <p data-v-e23d9750=""><?php echo e($client->name); ?></p>
                                        <pre data-v-e23d9750=""><?php echo e($client->email); ?></pre>
                                    </div>
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-end"><?php echo e($usr->estimateNumberFormat($estimation->estimation_id)); ?></td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb"><?php echo e(__('Issue Date')); ?>:</td>
                                                <td data-v-e23d9750="" class="text-end"><?php echo e($usr->dateFormat($estimation->issue_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-e23d9750="" class="d-table">
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="tu d-table-tr" style="border-bottom: 2px solid <?php echo e($color); ?>;">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-th w-3"><?php echo e(__('Price')); ?></div>
                                            <div data-v-e23d9750="" class="d-table-th w-2"><?php echo e(__('Qty')); ?></div>
                                            <div data-v-e23d9750="" class="d-table-th w-3 text-end"><?php echo e(__('Amount')); ?></div>
                                        </div>
                                        <div data-v-e23d9750="" class="d-table-body" style="border-bottom: 2px solid <?php echo e($color); ?>;">
                                                ...
                                                <?php $__currentLoopData = $estimation->getProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-13">
                                                            <pre data-v-e23d9750=""><?php echo e($item->name); ?><br data-v-e23d9750=""></pre>
                                                        </div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3"><span data-v-e23d9750=""><?php echo e($usr->priceFormat($item->pivot->price)); ?></span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-2"><span data-v-e23d9750=""><?php echo e($item->pivot->quantity); ?></span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3 text-end"><span data-v-e23d9750=""><?php echo e($usr->priceFormat($item->pivot->price * $item->pivot->quantity)); ?></span></div>
                                                    </div>
                                            ...
                                            <?php else: ?>
                                                <div data-v-e23d9750="" class="d-table-tr">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-td w-2"><span data-v-e23d9750="">-</span></div>
                                                    <div data-v-e23d9750="" class="d-table-td w-3 text-end"><span data-v-e23d9750="">-</span></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal())); ?></div>
                                                </div>
                                                <?php if($estimation->discount): ?>
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                        <div data-v-e23d9750="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->discount)); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($estimation->getTax()): ?>
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label"><?php echo e($estimation->tax->name); ?> (<?php echo e($estimation->tax->rate); ?>%):</div>
                                                        <div data-v-e23d9750="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getTax())); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label"><?php echo e(__('Total')); ?>:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/estimations/templates/template5.blade.php ENDPATH**/ ?>