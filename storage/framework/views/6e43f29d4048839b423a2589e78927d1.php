...
<?php $__env->startSection('page-subtitle'); ?>
    <?php echo e(__('Follow supplier commitments, approval stages and procurement throughput in a single list.')); ?>
        ...
        <div class="col-12 mb-4">
            <div class="ux-kpi-grid">
                <div class="ux-kpi-card">
                    <span class="ux-kpi-label"><?php echo e(__('Pending purchases')); ?></span>
                    <strong class="ux-kpi-value"><?php echo e($pendingPurchases); ?></strong>
                    <span class="ux-kpi-meta"><?php echo e(__('draft or waiting approval')); ?></span>
                </div>
                <div class="ux-kpi-card">
                    <span class="ux-kpi-label"><?php echo e(__('Rejected purchases')); ?></span>
                    <strong class="ux-kpi-value"><?php echo e($rejectedPurchases); ?></strong>
                    <span class="ux-kpi-meta"><?php echo e(__('blocked requests')); ?></span>
                </div>
                <div class="ux-kpi-card">
                    <span class="ux-kpi-label"><?php echo e(__('Completed flow')); ?></span>
                    <strong class="ux-kpi-value"><?php echo e($completedPurchases); ?></strong>
                    <span class="ux-kpi-meta"><?php echo e(__('received or billed')); ?></span>
                </div>
                <div class="ux-kpi-card">
                    <span class="ux-kpi-label"><?php echo e(__('Active vendors')); ?></span>
                    <strong class="ux-kpi-value"><?php echo e($vendorCount); ?></strong>
                    <span class="ux-kpi-meta"><?php echo e(__('suppliers used in this list')); ?></span>
                </div>
            </div>
        </div>
        <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr data-bulk-id="<?php echo e($purchase->id); ?>">
                                    <td class="Id">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/purchase/index.blade.php ENDPATH**/ ?>