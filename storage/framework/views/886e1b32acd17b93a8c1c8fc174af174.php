                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $payRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('amount.request',[$transaction->id,1])); ?>" class="btn btn-success btn-sm me-1" data-bs-toggle="tooltip" title="<?php echo e(__('Approve')); ?>" data-original-title="<?php echo e(__('Approve')); ?>">
                                                            <i class="ti ti-check"></i>
                                                        </a>
                                                        <a href="<?php echo e(route('amount.request',[$transaction->id,0])); ?>" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="<?php echo e(__('Reject')); ?>" data-original-title="<?php echo e(__('Reject')); ?>">
                                                        <i class="ti ti-x"></i>
                                                        </a>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/referral-program/index.blade.php ENDPATH**/ ?>