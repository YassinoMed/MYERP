                                        ...
                                        <table class="table pc-dt-simple" id="report-customer-balance">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $total = 0;
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $resultArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receivableCustomer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        <td> <?php echo e(!empty($receivableCustomer['credit_price']) ? \Auth::user()->priceFormat($receivableCustomer['credit_price']) : \Auth::user()->priceFormat(0)); ?></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table pc-dt-simple" id="report-receivable-summary">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $receivableSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receivableSummary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <td> <?php echo $receivableSummary['name'] ? $receivableSummary['name'] : '<span class="p-2 px-3">-</span>'; ?></td>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <td>
                                                                <?php if($receivableSummary['status'] == 0): ?>
                                                                    <span
                                                                        class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableSummary['status']])); ?></span>
                                                                <?php elseif($receivableSummary['status'] == 1): ?>
                                                                    <span
                                                                        class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableSummary['status']])); ?></span>
                                                                <?php elseif($receivableSummary['status'] == 2): ?>
                                                                    <span
                                                                        class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableSummary['status']])); ?></span>
                                                                <?php elseif($receivableSummary['status'] == 3): ?>
                                                                    <span
                                                                        class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableSummary['status']])); ?></span>
                                                                <?php elseif($receivableSummary['status'] == 4): ?>
                                                                    <span
                                                                        class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableSummary['status']])); ?></span>
                                                                <?php else: ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table pc-dt-simple" id="report-receivable-details">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $receivableDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receivableDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <td> <?php echo $receivableDetail['name'] ? $receivableDetail['name'] : '<span class="p-2 px-3">-</span>'; ?></td>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <td>
                                                                <?php if($receivableDetail['status'] == 0): ?>
                                                                    <span
                                                                        class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableDetail['status']])); ?></span>
                                                                <?php elseif($receivableDetail['status'] == 1): ?>
                                                                    <span
                                                                        class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableDetail['status']])); ?></span>
                                                                <?php elseif($receivableDetail['status'] == 2): ?>
                                                                    <span
                                                                        class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableDetail['status']])); ?></span>
                                                                <?php elseif($receivableDetail['status'] == 3): ?>
                                                                    <span
                                                                        class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableDetail['status']])); ?></span>
                                                                <?php elseif($receivableDetail['status'] == 4): ?>
                                                                    <span
                                                                        class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$receivableDetail['status']])); ?></span>
                                                                <?php else: ?>
                                                                    <span class="p-2 px-3">-</span>
                                                                <?php endif; ?>
                                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($value['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$value['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($day31to45['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day31to45['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($day16to30['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day16to30['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($day1to15['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$day1to15['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($current['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Invoice::$statues[$current['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/receivable_report.blade.php ENDPATH**/ ?>