<?php echo e(Form::open(['url' => 'software-licenses', 'method' => 'post'])); ?>
...
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('assigned_user_id', __('Assigned User'), ['class'=>'form-label'])); ?><?php echo e(Form::select('assigned_user_id', $users, null, ['class'=>'form-control select'])); ?></div></div>
...
<div class="col-md-3"><div class="form-group"><?php echo e(Form::label('seats_total', __('Seats Total'), ['class'=>'form-label'])); ?><?php echo e(Form::number('seats_total', 1, ['class'=>'form-control','min'=>'1'])); ?></div></div>
<div class="col-md-3"><div class="form-group"><?php echo e(Form::label('seats_used', __('Seats Used'), ['class'=>'form-label'])); ?><?php echo e(Form::number('seats_used', 0, ['class'=>'form-control','min'=>'0'])); ?></div></div>
<div class="col-md-6"><div class="form-group"><?php echo e(Form::label('renewal_date', __('Renewal Date'), ['class'=>'form-label'])); ?><?php echo e(Form::date('renewal_date', null, ['class'=>'form-control'])); ?></div></div>
<div class="col-md-6"><div class="form-group"><?php echo e(Form::label('cost', __('Cost'), ['class'=>'form-label'])); ?><?php echo e(Form::number('cost', 0, ['class'=>'form-control','step'=>'0.01','min'=>'0'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/software_licenses/create.blade.php ENDPATH**/ ?>