...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('projects.show', $project->id)); ?>">
            <?php echo e(ucwords($project->project_name)); ?></a>
    </li>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var html = '<div class="col-8 mb-2 file-' + data.id + '">' +
                        ...
                        '">' +
                        '                                    <div class="comment-trash" style="float: right">' +
                        '                                        <a download href="<?php echo e(asset(Storage::url('bugs'))); ?>/' +
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug report')): ?>
            <a href="<?php echo e(route('task.bug', $project->id)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('List')); ?>"
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create bug report')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('task.bug.create', $project->id)); ?>" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="<?php echo e(__('Create New Bug')); ?>" class="btn btn-sm btn-primary">
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="row kanban-wrapper horizontal-scroll-cards" data-containers='<?php echo e(json_encode($json)); ?>'
                data-plugin="dragula">
                    ...
                    <div class="col">
                        <div class="crm-sales-card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between gap-3">
                                ...
                                <span class="f-w-600 count"><?php echo e(count($bugs)); ?></span>
                            </div>
                            <div class="sales-item-wrp kanban-box" id="task-list-<?php echo e($status->id); ?>" data-id="<?php echo e($status->id); ?>">
                                <?php $__currentLoopData = $bugs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="sales-item draggable-item" id="<?php echo e($bug->id); ?>">
                                        <div class="sales-item-top border-bottom">
                                            <div class="d-flex align-items-center">
                                                <h5 class="mb-0 flex-1">
                                                    <a href="#" class="dashboard-link"
                                                        data-url="<?php echo e(route('task.bug.show', [$project->id, $bug->id])); ?>"
                                                        data-ajax-popup="true" data-size="lg"
                                                        data-bs-original-title="<?php echo e($bug->title); ?>"><?php echo e($bug->title); ?></a>
                                                </h5>
                                                    ...
                                                    <?php if(Gate::check('edit bug report') || Gate::check('delete bug report')): ?>
                                                        <div class="dropdown-menu icon-dropdown dropdown-menu-end">
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project task')): ?>
                                                                <a href="#!" data-size="lg"
                                                                    data-url="<?php echo e(route('task.bug.edit', [$project->id, $bug->id])); ?>"
                                                                    data-ajax-popup="true" class="dropdown-item"
                                                                    data-bs-original-title="<?php echo e(__('Edit ') . $bug->name); ?>">
                                            ...
                                            <div class="badge-wrp d-flex flex-wrap align-items-center gap-2">
                                                <?php if($bug->priority == 'low'): ?>
                                                    <span
                                                        class="badge p-2 rounded text-md f-w-600 bg-light-success"><?php echo e(ucfirst($bug->priority)); ?></span>
                                                <?php elseif($bug->priority == 'medium'): ?>
                                                    <span
                                                        class="badge p-2 rounded text-md f-w-600 bg-light-warning"><?php echo e(ucfirst($bug->priority)); ?></span>
                                                <?php elseif($bug->priority == 'high'): ?>
                                                    <span
                                                        class="badge p-2 rounded text-md f-w-600 bg-light-danger"><?php echo e(ucfirst($bug->priority)); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="sales-item-center border-bottom d-flex align-items-center justify-content-between">
                                            <span data-bs-toggle="tooltip" title="<?php echo e(__('Start Date')); ?>">
                                                <?php echo e(\Auth::user()->dateFormat($bug->start_date)); ?>

                                            </span>
                                            <span data-bs-toggle="tooltip" title="<?php echo e(__('End Date')); ?>">
                                                <?php echo e(\Auth::user()->dateFormat($bug->due_date)); ?>

                                            </span>
                                        </div>
                                        <div class="sales-item-bottom d-flex align-items-center justify-content-between">
                                            <div class="user-group">
                                                <img <?php if(isset($user[0]->avatar)): ?> src="<?php echo e(asset('/storage/uploads/avatar/' . $user[0]->avatar)); ?>" <?php else: ?> src="<?php echo e(asset('/storage/uploads/avatar/avatar.png')); ?>" <?php endif; ?>
                                                    alt="image" data-bs-toggle="tooltip"
                                                    title="<?php echo e(!empty($user[0]) ? $user[0]->name : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/projects/bugKanban.blade.php ENDPATH**/ ?>