...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
           $(document).on("change", "select[name='purchase_template'], input[name='purchase_color']", function() {
            ...
            $('#quotation_frame').attr('src', '<?php echo e(url('/quotation/preview')); ?>/' + template + '/' + color);
            });
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="form-check form-switch custom-switch-v1 mt-2">
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    <?php echo e(isset($settings['pos_purchase_qr_display']) && $settings['pos_purchase_qr_display'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row company-setting">
                                <div class="col-md-3">
                                    <div class="card-body">
                                        ...
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('quotation.template.setting')); ?>"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="address"
                                                    class="form-label"><?php echo e(__('Quotation Template')); ?></label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/settings/pos.blade.php ENDPATH**/ ?>