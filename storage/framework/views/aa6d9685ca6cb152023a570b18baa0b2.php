                                ...
                                <table class="table datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200px" class="flex-end"><?php echo e(__('Action')); ?></th>
                                        </tr>
                                    </thead>
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete branch')): ?>
                                                            <div class="action-btn ">
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    data-confirm-yes="document.getElementById('delete-form-<?php echo e($branch->id); ?>').submit();"><i
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/branch/index.blade.php ENDPATH**/ ?>