                            ...
                            <div class="row">
                                <div class="col-md-5 mb-3 mb-md-0">
                                    <div class = "border rounded p-3 mb-0">
                                        <h4><?php echo e(__('Refer ') . $companyName .  __(' and earn ') . (isset($setting) ? $setting->minimum_threshold_amount : '') . __('% per paid signup!')); ?></h4>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <h4><?php echo e(__('Share Your Link')); ?></h4>
                                    ...
                                    <div class="col-md-6 col-12 payout-card">
                                        <div class="payout-card-inner d-flex align-items-start gap-3">
                                            ...
                                            <div class="payout-content flex-1">
                                                ...
                                                <h2 class="h5 mb-0"><?php echo e(__('Commission Amount')); ?></h2>
                                            </div>
                                            <h3 class="h4 mb-0"><?php echo e($currency . \Auth::user()->commission_amount); ?></h3>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 payout-card">
                                        <div class="payout-card-inner d-flex align-items-start gap-3">
                                            ...
                                            <div class="payout-content flex-1">
                                                <span class="text-sm d-block mb-1"><?php echo e(__('Paid')); ?></span>
                                                <h2 class="h5 mb-0"><?php echo e(__('Paid Amount')); ?></h2>
                                            </div>
                                            <h3 class="h4 mb-0"><?php echo e($currency . $paidAmount); ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/referral-program/company.blade.php ENDPATH**/ ?>