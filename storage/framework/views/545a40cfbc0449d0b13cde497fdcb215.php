                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="float-end mt-3">
                                            <?php if(isset($settings['invoice_qr_display']) == 'on'): ?>
                                            ...
                                            <table class="table mb-0 table-striped">
                                                ...
                                                <?php $__currentLoopData = $iteams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $iteam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <td><?php echo e($iteam->quantity); ?>

                                                            <?php echo e($unitName != null ? '(' . $unitName->name . ')' : ''); ?>
                                                        ...
                                                        <td class="text-end">
                                                            <?php echo e(Utility::priceFormat($settings, $iteam->price * $iteam->quantity - $iteam->discount + $itemTaxPrice)); ?>
                                ...
                                <section class="nav-tabs p-2">
                                    <?php if(
                                        ...
                                        <ul class="nav nav-pills  mb-3" role="tablist">
                                            ...
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['is_paiementpro_enabled']) &&
                                                    $company_payment_setting['is_paiementpro_enabled'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#paiementpro-payment"
                                                        role="tab" aria-controls="paiementpro"
                                                        aria-selected="false"><?php echo e(__('Paiement Pro')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['is_cinetpay_enabled']) && $company_payment_setting['is_cinetpay_enabled'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#cinetpay-payment"
                                                        role="tab" aria-controls="cinetpay"
                                                        aria-selected="false"><?php echo e(__('Cinetpay')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['is_fedapay_enabled']) && $company_payment_setting['is_fedapay_enabled'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#fedapay-payment"
                                                        role="tab" aria-controls="fedapay"
                                                        aria-selected="false"><?php echo e(__('Fedapay')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['is_payhere_enabled']) && $company_payment_setting['is_payhere_enabled'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#payhere-payment"
                                                        role="tab" aria-controls="payhere"
                                                        aria-selected="false"><?php echo e(__('PayHere')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['tap_payment_is_on']) && $company_payment_setting['tap_payment_is_on'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#tap-payment"
                                                        role="tab" aria-controls="tap"
                                                        aria-selected="false"><?php echo e(__('Tap')); ?></a>
                                                </li>
                                             <?php endif; ?>
                                             <?php if(isset($company_payment_setting['authorizenet_payment_is_on']) && $company_payment_setting['authorizenet_payment_is_on'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#authorizenet-payment"
                                                        role="tab" aria-controls="tap"
                                                        aria-selected="false"><?php echo e(__('AuthorizeNet')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['khalti_payment_is_on']) && $company_payment_setting['khalti_payment_is_on'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#khalti-payment"
                                                        role="tab" aria-controls="tap"
                                                        aria-selected="false"><?php echo e(__('Khalti')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['easebuzz_payment_is_on']) && $company_payment_setting['easebuzz_payment_is_on'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#easebuzz-payment"
                                                        role="tab" aria-controls="tap"
                                                        aria-selected="false"><?php echo e(__('Easebuzz')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if(isset($company_payment_setting['company_ozow_payment_is_enabled']) && $company_payment_setting['company_ozow_payment_is_enabled'] == 'on'): ?>
                                                <li class="nav-item mb-2">
                                                    <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                        data-bs-toggle="tab" href="#ozow-payment"
                                                        role="tab" aria-controls="ozow"
                                                        aria-selected="false"><?php echo e(__('Ozow')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    <?php endif; ?>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name"
                                                                    id="card-name-on" class="form-control required" placeholder="<?php echo e(__('Enter Name')); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div id="card-element">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" required="required"
                                                                    ...
                                                                    value="<?php echo e($invoice->getDue()); ?>" min="0"
                                                                    step="0.01" max="<?php echo e($invoice->getDue()); ?>"
                                                                    id="amount" placeholder="<?php echo e(__('Enter Amount')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" required="required"
                                                                ...
                                                                value="<?php echo e($invoice->getDue()); ?>" min="0"
                                                                step="0.01" max="<?php echo e($invoice->getDue()); ?>"
                                                                id="pay_fast_amount" onchange=get_payfast_status()  placeholder="<?php echo e(__('Enter Amount')); ?>">
                                                        </div>
                                                    </div>
                                        ...
                                        <?php if(isset($company_payment_setting['is_nepalste_enabled']) && $company_payment_setting['is_nepalste_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="nepalste-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.with.nepalste')); ?>" method="post"
                                        ...
                                        <?php if(isset($company_payment_setting['is_paiementpro_enabled']) &&
                                            ...
                                            <div class="tab-pane fade" id="paiementpro-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.with.paiementpro')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['is_cinetpay_enabled']) && $company_payment_setting['is_cinetpay_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="cinetpay-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.with.cinetpay')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['is_fedapay_enabled']) && $company_payment_setting['is_fedapay_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="fedapay-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.with.fedapay')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['is_payhere_enabled']) && $company_payment_setting['is_payhere_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="payhere-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.with.payhere')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['tap_payment_is_on']) && $company_payment_setting['tap_payment_is_on'] == 'on'): ?>
                                            <div class="tab-pane fade" id="tap-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('invoice.pay.with.tap')); ?>"
                                                    method="post" class="require-validation"
                                                    id="tap-payment-form">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="invoice_id"
                                        ...
                                        <?php if(isset($company_payment_setting['authorizenet_payment_is_on']) && $company_payment_setting['authorizenet_payment_is_on'] == 'on'): ?>
                                            <div class="tab-pane fade" id="authorizenet-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('invoice.pay.with.authorizenet')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['easebuzz_payment_is_on']) && $company_payment_setting['easebuzz_payment_is_on'] == 'on'): ?>
                                            <div class="tab-pane fade" id="easebuzz-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('invoice.pay.with.easebuzz')); ?>"
                                                    method="post" class="require-validation"
                                        ...
                                        <?php if(isset($company_payment_setting['company_ozow_payment_is_enabled']) && $company_payment_setting['company_ozow_payment_is_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="ozow-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('invoice.pay.with.ozow')); ?>"
                                                    method="post" class="require-validation"
    ...
    var config = {
        "publicKey": "<?php echo e(isset($company_payment_setting['khalti_public_key']) ? $company_payment_setting['khalti_public_key'] : ''); ?>",
        ...
        "eventHandler": {
            onSuccess (payload) {
                if(payload.status==200) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('invoice.pay.with.khalti')); ?>',
                        method: 'POST',
                        data : {
                            'payload' : payload,
    ...
    $(document).on('click', '#pay_with_khalti', function () {
        var account = "<?php echo e($khaltiAccount); ?>";
        if(account == '')
        {
            show_toastr('Error', '<?php echo e(__("Bank account not connected with Khalti.")); ?>', 'error')
            return;
        } 
    ...
    <script type="text/javascript">
        ...
        <?php if(isset($company_payment_setting['paystack_public_key'])): ?>
            $(document).on("click", "#pay_with_paystack", function() {
                var account = "<?php echo e($paystackAccount); ?>";
                if(account == '')
                {
                    show_toastr('Error', '<?php echo e(__("Bank account not connected with Paystack.")); ?>', 'error')
                    return;
                } 
        ...
        <?php if(isset($company_payment_setting['flutterwave_public_key'])): ?>
            ...
            $(document).on("click", "#pay_with_flaterwave", function() {
                var account = "<?php echo e($flutterwaveAccount); ?>";
                if(account == '')
                {
                    show_toastr('Error', '<?php echo e(__("Bank account not connected with Flutterwave.")); ?>', 'error')
                    return;
                } 
        ...
        <?php if(isset($company_payment_setting['razorpay_public_key'])): ?>
            $(document).on("click", "#pay_with_razorpay", function() {
                var account = "<?php echo e($razorpayAccount); ?>";
                if(account == '')
                {
                    show_toastr('Error', '<?php echo e(__("Bank account not connected with Razorpay.")); ?>', 'error')
                    return;
                } 
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/invoice/customer_invoice.blade.php ENDPATH**/ ?>