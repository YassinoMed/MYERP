                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('report_tax_summary').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Tax Summary')); ?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="table-responsive mt-3 mb-3">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_0 = true; $__currentLoopData = array_keys($incomes); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $taxName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                        <tr>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php $__empty_0 = true; $__currentLoopData = array_keys($expenses); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $taxName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                        <tr>
                                            <td><?php echo e($taxName); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/tax_summary.blade.php ENDPATH**/ ?>