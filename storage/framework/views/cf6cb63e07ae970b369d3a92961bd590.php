                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                <h5 class="mb-0"><?php echo e(__('Employee Salary')); ?></h5>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create set salary')): ?>
                                    <div class="col text-end">
                                        <a href="#" data-url="<?php echo e(route('employee.basic.salary', $employee->id)); ?>"
                                            data-size="md" data-ajax-popup="true" data-title="<?php echo e(__('Set Basic Sallary')); ?>"
                                ...
                                <div class="project-info d-flex">
                                    <div class="project-info-inner mr-3 col-4">
                                        ...
                                        <div class="project-amnt pt-1">
                                            <?php if(!empty($employee->salaryType)): ?>
                                                <?php echo e($employee->salaryType->name); ?>
                                    ...
                                    <div class="project-info-inner mr-3 col-4">
                                        ...
                                        <div class="project-amnt pt-1">
                                            <?php if(!empty($employee->bankAccount)): ?>
                                                <?php echo e($employee->bankAccount->bank_name); ?>
                    ...
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            ...
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between ">
                                        <h5 class="mb-0"><?php echo e(__('Allowance')); ?></h5>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create allowance')): ?>
                                            <a href="#!" data-url="<?php echo e(route('allowances.create', $employee->id)); ?>"
                                                data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Create Allowance')); ?>"
                                                data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                                                data-original-title="<?php echo e(__('Create Allowance')); ?>"
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $allowances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allowance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(!empty($allowance->allowanceOption) ? $allowance->allowanceOption->name : ''); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <td><?php echo e($allowance->amount); ?>%
                                                                ($<?php echo e($allowance->tota_allow); ?>)</td>
                                                        <?php endif; ?>
                                                        <?php if(\Auth::user()->type != 'Employee'): ?>
                                                            <td class="">
                    ...
                    <div class="col-md-6">
                        <div class="card  min-height-253">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h5 class="mb-0"><?php echo e(__('Commission')); ?></h5>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create commission')): ?>
                                            <a href="#!" data-url="<?php echo e(route('commissions.create', $employee->id)); ?>"
                                                data-size="lg" data-ajax-popup="true"
                                                data-title="<?php echo e(__('Create Commission')); ?>" data-bs-toggle="tooltip"
                                                title="<?php echo e(__('Create')); ?>"
                                                data-original-title="<?php echo e(__('Create Commission')); ?>"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                    <?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        ...
                                        <h5 class="mb-0"><?php echo e(__('Loan')); ?></h5>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create loan')): ?>
                                            <a href="#!" data-url="<?php echo e(route('loans.create', $employee->id)); ?>"
                                                data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Create Loan')); ?>"
                                                data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                                                data-original-title="<?php echo e(__('Create Loan')); ?>"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                    <?php endif; ?>
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($employee->name); ?></td>
                                                        <td><?php echo e(!empty($loan->loanOption) ? $loan->loanOption->name : ''); ?>
                    ...
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h5 class="mb-0"><?php echo e(__('Saturation Deduction')); ?></h5>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create saturation deduction')): ?>
                                            <a href="#!"
                                                data-url="<?php echo e(route('saturationdeductions.create', $employee->id)); ?>"
                                                data-size="lg" data-ajax-popup="true"
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $saturationdeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saturationdeduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($employee->name); ?></td>
                                                        <td><?php echo e(!empty($saturationdeduction->deductionOption) ? $saturationdeduction->deductionOption->name : ''); ?>
                                                        ...
                                                        <?php else: ?>
                                                            <td><?php echo e($saturationdeduction->amount); ?>%
                                                                ($<?php echo e($saturationdeduction->tota_allow); ?>)</td>
                                                        <?php endif; ?>
                                                        <?php if(\Auth::user()->type != 'Employee'): ?>
                                                            <td class="">
                    ...
                    <div class="col-md-6">
                        <div class="card min-height-253">
                            <div class="card-header d-flex align-items-center gap-2 flex-wrap justify-content-between">
                                        <h5 class="mb-0"><?php echo e(__('Other Payment')); ?></h5>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create other payment')): ?>
                                            <a href="#!" data-url="<?php echo e(route('otherpayments.create', $employee->id)); ?>"
                                                ...
                                                title="<?php echo e(__('Create')); ?>"
                                                data-original-title="<?php echo e(__('Create Other Payment')); ?>"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                    <?php endif; ?>
                                                ...
                                                <?php $__currentLoopData = $otherpayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <?php if($otherpayment->type == 'fixed'): ?>
                                                            <td><?php echo e(\Auth::user()->priceFormat($otherpayment->amount)); ?>

                                                            </td>
                                                        <?php else: ?>
                                                            <td><?php echo e($otherpayment->amount); ?>%
                                                                ($<?php echo e($otherpayment->tota_allow); ?>)</td>
                                                        <?php endif; ?>
                                                        <?php if(\Auth::user()->type != 'Employee'): ?>
                                                            <td class="">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/setsalary/employee_salary.blade.php ENDPATH**/ ?>