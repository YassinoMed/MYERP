                                        ...
                                        <div class="card h-100 mb-0">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="form-check form-switch d-flex gap-2 flex-column p-0 mt-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input mx-0"
                                                        id="cust-darklayout-auto" name="cust_darklayout_auto"
                                                        <?php echo e(!empty($setting['cust_darklayout_auto']) && $setting['cust_darklayout_auto'] == 'on' ? 'checked' : ''); ?> />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row row-gap-2">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="color" class="form-control form-control-color"
                                                            ...
                                                            value="<?php echo e(!empty($setting['module_color_default']) ? $setting['module_color_default'] : '#6FD943'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="color" class="form-control form-control-color"
                                                            ...
                                                            value="<?php echo e(!empty($setting['module_color_account']) ? $setting['module_color_account'] : '#4b7bec'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-crm"><?php echo e(__('CRM')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-crm" name="module_color_crm"
                                                            value="<?php echo e(!empty($setting['module_color_crm']) ? $setting['module_color_crm'] : '#20bf6b'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-hrm"><?php echo e(__('HRM')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-hrm" name="module_color_hrm"
                                                            value="<?php echo e(!empty($setting['module_color_hrm']) ? $setting['module_color_hrm'] : '#eb3b5a'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="color" class="form-control form-control-color"
                                                            ...
                                                            value="<?php echo e(!empty($setting['module_color_project']) ? $setting['module_color_project'] : '#f7b731'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-pos"><?php echo e(__('POS')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-pos" name="module_color_pos"
                                                            value="<?php echo e(!empty($setting['module_color_pos']) ? $setting['module_color_pos'] : '#2d98da'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/settings/company.blade.php ENDPATH**/ ?>