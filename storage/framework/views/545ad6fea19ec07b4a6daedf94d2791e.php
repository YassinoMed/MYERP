    ...
    <div class="navbar-content">
        <?php if(\Auth::user()->type != 'client' && \Auth::user()->type != 'super admin'): ?>
            <ul class="dash-navbar">
                ...
                <?php elseif(!Gate::check('show hrm dashboard') ||
                    !Gate::check('show project dashboard') ||
                    !Gate::check('show account dashboard') ||
                    !Gate::check('show crm dashboard') ||
                    !Gate::check('show pos dashboard')
                     && \Auth::user()->type != 'super admin'): ?>
                        ...
                        <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == null || Request::segment(1) == 'dashboard' ? ' active' : ''); ?>">
        ...
        <?php if(\Auth::user()->type == 'client'): ?>
            <ul class="dash-navbar">
                <?php if(Gate::check('manage client dashboard')): ?>
                    <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'client-dashboard' ? ' active' : ''); ?>">
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/partials/admin/dashboard_menu_bkp.blade.php ENDPATH**/ ?>