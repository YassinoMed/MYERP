        ...
        <?php $__currentLoopData = $deal->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(file_exists(storage_path('deal_files/' . $file->file_path))): ?>
                ...
                var mockFile = {
                    ...
                    size: <?php echo e(\File::size(storage_path('deal_files/' . $file->file_path))); ?>
                ...
                dropzoneBtn(mockFile, {
                    download: "<?php echo e(route('deals.file.download', [$deal->id, $file->id])); ?>",
                    delete: "<?php echo e(route('deals.file.delete', [$deal->id, $file->id])); ?>"
                });
            <?php endif; ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('convert deal to deal')): ?>
            ...
            <?php else: ?>
                <a href="#" data-size="lg" data-url="<?php echo e(URL::to('deals/' . $deal->id . '/show_convert')); ?>"
                    data-bs-toggle="tooltip" title="<?php echo e(__('Convert [' . $deal->subject . '] To Deal')); ?>"
                    class="btn btn-sm bg-warning-subtle me-1">
                    <i class="ti ti-exchange"></i>
                </a>
            <?php endif; ?>
        <?php endif; ?>
        <a href="#" data-url="<?php echo e(URL::to('deals/' . $deal->id . '/labels')); ?>" data-ajax-popup="true" data-size="lg"
            data-bs-toggle="tooltip" title="<?php echo e(__('Label')); ?>" class="btn btn-sm btn-primary me-1">
            <i class="ti ti-bookmark"></i>
        </a>
        <a href="#" data-size="lg" data-url="<?php echo e(route('deals.edit', $deal->id)); ?>" data-ajax-popup="true"
            data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" class="btn btn-sm btn-info">
            ...
            <div class="row">
                            ...
                            <div class="card report-card h-100 mb-0">
                                <div class="card-body d-flex align-items-center gap-3">
                                    ...
                                    <div class="report-info flex-1">
                                        ...
                                        <p class="text-muted mb-0"><?php echo e($deal->pipeline->name); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card report-card h-100 mb-0">
                                <div class="card-body d-flex align-items-center gap-3">
                                    ...
                                    <div class="report-info flex-1">
                                        ...
                                        <p class="text-muted mb-0"><?php echo e($deal->stage->name); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card report-card h-100 mb-0">
                                <div class="card-body d-flex align-items-center gap-3">
                                    ...
                                    <div class="report-info flex-1">
                                        ...
                                        <p class="text-muted mb-0"><?php echo e(\Auth::user()->dateFormat($deal->created_at)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-sm-6 col-12 mb-4">
                            <div class="card report-card h-100 mb-0">
                                <div class="card-body d-flex align-items-center gap-3">
                                    ...
                                    <div class="report-info flex-1">
                                        <h5 class="mb-1"><?php echo e(__('Price')); ?></h5>
                                        <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($deal->price)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-3 col-sm-6 col-12 leave-card mb-4">
                            <div class="leave-card-inner d-flex align-items-center gap-3">
                                ...
                                <div class="leave-info">
                                    <h5 class="mb-2"><?php echo e(__('Task')); ?></h5>
                                    <span class="h3"><?php echo e(count($tasks)); ?></span>
                                </div>
                        ...
                        <div class="col-xxl-3 col-sm-6 col-12 leave-card mb-4">
                            <div class="leave-card-inner d-flex align-items-center gap-3">
                                ...
                                <div class="leave-info">
                                    ...
                                    <span class="h3"><?php echo e(count($deal->files)); ?></span>
                                </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create task')): ?>
                                    <div class="float-end">
                                        <a href="#" data-size="lg"
                                            data-url="<?php echo e(route('deals.tasks.create', $deal->id)); ?>" data-ajax-popup="true"
                                            data-bs-toggle="tooltip" title="<?php echo e(__('Add Task')); ?>"
                                            ...
                                            <div class="d-block d-sm-flex align-items-start">
                                                <div
                                                    ...
                                                    <input class="form-check-input task-checkbox" type="checkbox"
                                                        role="switch" id="task_<?php echo e($task->id); ?>"
                                                        <?php if($task->status): ?> checked="checked" <?php endif; ?> value="<?php echo e($task->status); ?>" data-url="<?php echo e(route('deals.tasks.update_status', [$deal->id, $task->id])); ?>">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="mb-3 mb-sm-0">
                                                            <h5 class="mb-0">
                                                                ...
                                                                <?php else: ?>
                                                                    <div class="badge bg-warning mb-1"><?php echo e(__(\App\Models\DealTask::$status[$task->status])); ?></div> <?php endif; ?>
                                                        </h5>
                                                    <small
                                                        class="text-sm"><?php echo e(__(\App\Models\DealTask::$priorities[$task->priority])); ?>

                                                        - <?php echo e(Auth::user()->dateFormat($task->date)); ?>

                                                        <?php echo e(Auth::user()->timeFormat($task->time)); ?></small>
                                                    <span class="text-muted text-sm">
                                                        <?php if($task->status): ?>
                                                            <div class="badge status_badge badge-pill badge-success mb-1">
                                                                <?php echo e(__(\App\Models\DealTask::$status[$task->status])); ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit task')): ?>
                                                        <div class="action-btn me-2">
                                                            <a href="#"
                                                                ...
                                                                data-url="<?php echo e(route('deals.tasks.edit', [$deal->id, $task->id])); ?>"
                ...
                <?php else: ?>
                    <div class="text-center">
                        <?php echo e(__('No Tasks Available.!')); ?>
                        ...
                        <div class="card h-100 mb-0">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="float-end">
                                        <a data-size="md" data-url="<?php echo e(route('deals.users.edit', $deal->id)); ?>"
                                            data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Add User')); ?>"
                                            class="btn btn-sm btn-primary">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="card h-100 mb-0">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="float-end">
                                        <a data-size="md" data-url="<?php echo e(route('deals.products.edit', $deal->id)); ?>"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="card h-100 mb-0">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="float-end">
                                        <a data-size="md" data-url="<?php echo e(route('deals.sources.edit', $deal->id)); ?>"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create deal email')): ?>
                                        <div class="float-end">
                                            <a data-size="lg" data-url="<?php echo e(route('deals.emails.create', $deal->id)); ?>"
                                                data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="card h-100 mb-0">
                            <div class="card-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="float-end">
                                        <a data-size="lg" data-url="<?php echo e(route('deals.discussions.create', $deal->id)); ?>"
                                            data-ajax-popup="true" data-bs-toggle="tooltip"
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create deal call')): ?>
                            <div class="float-end">
                                <a data-size="lg" data-url="<?php echo e(route('deals.calls.create', $deal->id)); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit deal call')): ?>
                                                <div class="action-btn me-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bg-info"
                                                        data-url="<?php echo e(URL::to('deals/' . $deal->id . '/call/' . $call->id . '/edit')); ?>"
                                                        data-ajax-popup="true" data-size="xl" data-bs-toggle="tooltip"
                                                        title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Call')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/deals/show.blade.php ENDPATH**/ ?>