    ...
    <div class="modal-content">
        ...
        <div class="scrollbar-inner">
            <div class="modal-body">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-6">
                        <label class="form-label mb-0"><?php echo e(__('Attachments ewrwr')); ?></label>
                    </div>
                    <div class="col-6 text-end">
                ...
                <hr/>
                <label class="form-label mb-4"><?php echo e(__('Activity')); ?></label>
                ...
                <hr/>
                <label class="form-label mb-4"><?php echo e(__('Comments')); ?></label>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="#" class="avatar avatar-sm rounded-circle">
                                        <img <?php echo e($comment->user->img_avatar); ?> title="<?php echo e($comment->user->name); ?>">
                                    </a>
                                </div>
                                <div class="col ml-n2">
                                ...
                                <div class="col-auto">
                                    <a href="#" class="delete-comment" data-url="<?php echo e(route('comment.destroy',[$task->project_id,$task->id,$comment->id])); ?>"><i class="ti ti-trash-alt text-danger"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/tasks/show.blade.php ENDPATH**/ ?>