...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        (function () {
            var mainRow = document.getElementById('crm-dashboard-main-row');
...
<?php $__env->startSection('page-subtitle'); ?>
    <?php echo e(__('Watch lead generation, contract flow and deal conversion from a single commercial cockpit.')); ?>
...
<div class="row mb-4 gy-3" id="crm-dashboard-main-row">
    ...
    <div class="col-xl-4 col-sm-6 col-12 crm-dash-card dashboard-widget" data-widget="crm-total-deal">
        <div class="crm-card-inner d-flex align-items-center gap-3">
            <svg class="bottom-svg" width="135" height="80" viewBox="0 0 135 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M74.7692 35C27.8769 35 5.38462 65 0 80H135.692V0C134.923 11.6667 121.662 35 74.7692 35Z" fill="#FF3A6E"></path>
            </svg>
    ...
    <div class="col-xl-4 col-sm-6 col-12 crm-dash-card dashboard-widget" data-widget="crm-total-contract">
        <div class="crm-card-inner d-flex align-items-center gap-3">
            <svg class="bottom-svg" width="135" height="80" viewBox="0 0 135 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M74.7692 35C27.8769 35 5.38462 65 0 80H135.692V0C134.923 11.6667 121.662 35 74.7692 35Z" fill="#FF3A6E"></path>
            </svg>
        ...
        <div class="col-lg-6 mb-4 dashboard-widget" data-widget="crm-lead-status">
        ...
        <div class="col-lg-6 mb-4 dashboard-widget" data-widget="crm-deal-status">
            <div class="card h-100 mb-0">
                <div class="card-header">
        ...
        <div class="col-xxl-12 dashboard-widget" data-widget="crm-latest-contract">
            <div class="card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php $__empty_2 = true; $__currentLoopData = $crm_data['latestContract']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <tr>
                                    <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/crm-dashboard.blade.php ENDPATH**/ ?>