    ...
    <div class="pos-header">
        <table>
            ...
            <tr style="border-bottom:1px solid var(--theme-color);">
                ...
                <td class="text-right">
                    <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: var(--theme-color);"><?php echo e(__('POS')); ?></h3>
                </td>
            </tr>
            </tbody>
        </table>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/templates/template8.blade.php ENDPATH**/ ?>