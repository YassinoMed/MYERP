...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#import', function(event) {
            ...
            $.ajax({
                url: "<?php echo e(route('employee.import.data')); ?>",
                method: "POST",
                data: data,
                beforeSend: function() {
                    $('#import').attr('disabled', 'disabled');
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/employee/import_modal.blade.php ENDPATH**/ ?>