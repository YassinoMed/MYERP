...
<div class="pos-preview-main"  id="boxes">
    <div class="pos-header" style="">
        <table class="vertical-align-top">
            <tbody>
                <tr>
                    <td>
                        <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('POS')); ?></h3>
                    </td>
                ...
                <td>
                    <table class="no-space">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo e(Utility::dateFormat($settings,$pos->pos_date)); ?></td>
                        </tr>
    ...
    <div class="pos-body">
        ...
        <table class="pos-summary" style="border-bottom:1px solid <?php echo e($color); ?>;">
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('pos.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>;
<?php endif; ?>
</body>

</html>
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/templates/template3.blade.php ENDPATH**/ ?>