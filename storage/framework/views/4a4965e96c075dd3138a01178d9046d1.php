...
<?php echo e(Form::model($debitNote, array('route' => array('bill.custom-note.edit',$debitNote->bill, $debitNote->id), 'method' => 'post', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
            <select class="form-control select" required="required" id="bill" name="bill" disabled>
                ...
                <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($key == $debitNote->bill ? 'selected'  : ''); ?>><?php echo e(\Auth::user()->billNumberFormat($bill)); ?></option>
...
</script><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/customerDebitNote/edit.blade.php ENDPATH**/ ?>