<?php echo e(Form::open(['url' => 'insurance-policies', 'method' => 'post', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?><?php echo e(Form::text('provider_name', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        ...
        <div class="col-md-3"><div class="form-group"><?php echo e(Form::label('start_date', __('Start Date'), ['class' => 'form-label'])); ?><?php echo e(Form::date('start_date', null, ['class' => 'form-control'])); ?></div></div>
        <div class="col-md-3"><div class="form-group"><?php echo e(Form::label('end_date', __('End Date'), ['class' => 'form-label'])); ?><?php echo e(Form::date('end_date', null, ['class' => 'form-control'])); ?></div></div>
        <div class="col-md-3"><div class="form-group"><?php echo e(Form::label('premium_amount', __('Premium Amount'), ['class' => 'form-label'])); ?><?php echo e(Form::number('premium_amount', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => '0'])); ?></div></div>
        <div class="col-md-3"><div class="form-group"><?php echo e(Form::label('coverage_amount', __('Coverage Amount'), ['class' => 'form-label'])); ?><?php echo e(Form::number('coverage_amount', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => '0'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/insurance_policies/create.blade.php ENDPATH**/ ?>