                                    ...
                                    <td>
                                        ...
                                        <?php if(!empty($application->resume)): ?>
                                            <span class="action-btn me-2">
                                                <a class="mx-3 btn btn-sm align-items-center bg-primary "  href="<?php echo e($resumes. '/' . $application->resume); ?>"  data-bs-toggle="tooltip"
                                                   data-bs-original-title="<?php echo e(__('Download')); ?>"
                                                   download><i class="ti ti-download text-white"></i></a>
                                            </span>
                                            <div class="action-btn me-2">
                                                <a class="mx-3 btn btn-sm align-items-center bg-secondary " href="<?php echo e($resumes . '/' . $application->resume); ?>" target="_blank"  >
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show job application')): ?>
                                            <div class="action-btn me-2">
                                                ...
                                                <a class="mx-3 btn btn-sm  align-items-center bg-warning" data-bs-toggle="tooltip" title="<?php echo e(__('View')); ?>" data-title="<?php echo e(__('Details')); ?>" href="<?php echo e(route('job-application.show',\Crypt::encrypt($application->id))); ?>"> <i class="ti ti-eye text-white"></i></a>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/jobApplication/candidate.blade.php ENDPATH**/ ?>