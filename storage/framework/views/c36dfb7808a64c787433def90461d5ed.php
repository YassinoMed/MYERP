...
<div class="card bg-none card-box">
    <div class="card-body">
        ...
        <div class="text-end">
            <a title="<?php echo e(__('Download')); ?>" href="#" class="btn btn-sm btn-primary me-1" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Download')); ?>" onclick="saveAsPDF()"><span class="ti ti-download"></span></a>
            <a title="<?php echo e(__('Mail Send')); ?>" href="<?php echo e(route('payslip.send',[$employee->id,$payslip->salary_month])); ?>" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Mail Send')); ?>"><span class="ti ti-send"></span></a>
        </div>
                        ...
                        <div class="row text-sm">
                            <div class="col-md-6">
                                <address>
                                    ...
                                    <strong><?php echo e(__('Position')); ?> :</strong> <?php echo e(!empty($employee->designation)?$employee->designation->name:''); ?><br>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/payslip/pdf.blade.php ENDPATH**/ ?>