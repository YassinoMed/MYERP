...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div id="collab-indicator" class="collab-indicator" data-collab-resource="report" data-collab-id="dashboard" data-collab-label="<?php echo e(__('Report Dashboard')); ?>"></div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="user-text">
                        <h5><?php echo e(__('Employee ')); ?>: <?php echo e($countUser); ?></h5>
                        <h5><?php echo e(__('Client ')); ?>: <?php echo e($countClient); ?> </h5>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="user-text">
                        <h5><?php echo e(__('Trainer ')); ?>: <?php echo e($countTrainer); ?> </h5>
                        <h5><?php echo e(__('Active Training ')); ?>: <?php echo e($onGoingTraining); ?></h5>
                        <h5><?php echo e(__('Done Training ')); ?>: <?php echo e($doneTraining); ?></h5>
                    </div>
                    <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon"/>
                </div>
            </div>
            <?php if(\Auth::user()->type=='company'): ?>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="card card-box">
                        ...
                        <div class="user-text">
                            <h5><?php echo e(__('Active Job ')); ?>: <?php echo e($activeJob); ?></h5>
                            <h5><?php echo e(__('Inactive Job ')); ?>: <?php echo e($inActiveJOb); ?> </h5>
                        </div>
                    </div>
                    <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon"/>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/dashboard.blade.php ENDPATH**/ ?>