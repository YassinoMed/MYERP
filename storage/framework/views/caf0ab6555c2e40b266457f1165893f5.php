<?php echo e(Form::open(array('url' => 'support','enctype'=>"multipart/form-data", 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
            <?php echo e(Form::text('subject', '', array('class' => 'form-control ','required'=>'required', 'placeholder'=>__('Enter Support')))); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('support_category_id',$categories,null,array('class'=>'form-control select'))); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/support/create.blade.php ENDPATH**/ ?>