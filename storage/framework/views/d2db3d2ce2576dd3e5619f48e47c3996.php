        ...
        <select name="language" id="language" class="btn btn-primary my-2"
            ...
            <?php $__currentLoopData = \App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option <?php if($lang == $language): ?> selected <?php endif; ?>
                    value="<?php echo e(route('projects.link', [\Illuminate\Support\Facades\Crypt::encrypt($project->id), $language])); ?>">
            ...
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    <?php if(isset($result->bug_report) && $result->bug_report == 'on'): ?>
                        <a href="#bug_report"
                            class="list-group-item list-group-item-action border-0"><?php echo e(__('Bug Report')); ?>
                    ...
                    <?php if(isset($result->tracker_details) && $result->tracker_details == 'on'): ?>
                        <a href="#tracker_details"
                            class="list-group-item list-group-item-action border-0"><?php echo e(__('Tracker details')); ?>
                    ...
                    <?php if(isset($result->activity) && $result->activity == 'on'): ?>
                        <a href="#activity"
                            class="list-group-item list-group-item-action border-0"><?php echo e(__('Activity Log')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-12 leave-card mb-4">
                            <div class="leave-card-inner d-flex align-items-center gap-3">
                                ...
                                <div class="leave-info d-flex align-items-center justify-content-between gap-3 text-end">
                                    <h6 class="mb-0"><?php echo e(__('Total Task')); ?></h6>
                                    <span class="h4 mb-0"><?php echo e($project_data['task']['total']); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 col-12 leave-card mb-4">
                        ...
                        <div class="col-md-4 col-sm-6 col-12 leave-card mb-4">
                            <div class="leave-card-inner d-flex align-items-center gap-3">
                                ...
                                <div class="leave-info d-flex align-items-center justify-content-between gap-3 text-end">
                                    <h6 class="mb-0"><?php echo e(__('Total Milestone')); ?></h6>
                                    <span class="h4 mb-0"><?php echo e(count($project->milestones)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="mb-3 mb-sm-0">
                                                ...
                                                <div class="progress-wrapper">
                                                    <span class="progress-percentage"><small
                                                        ...
                                                        </small><?php echo e($project->project_progress_copy($usr->id)['percentage']); ?></span>
                                                    <div class="progress progress-xs mt-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            aria-valuenow="<?php echo e($project->project_progress_copy($usr->id)['percentage']); ?>"
                                                            aria-valuemin="0" aria-valuemax="100"
                                                            style="width: <?php echo e($project->project_progress_copy($usr->id)['percentage']); ?>;">
                                                        </div>
                                                    </div>
                                                </div>
                                                </p>
                                        ...
                                        <?php if(!empty(count($tasks)) > 0): ?>
                                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td
                                                        class="<?php echo e(strtotime($task->end_date) < time() ? 'text-danger' : ''); ?>">
                                ...
                                <table id="" class="table  px-2">
                                    ...
                                    <tbody>
                                        <?php if(!empty(count($project->milestones)) > 0): ?>
                                            <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge-xs status_badge badge bg-<?php echo e(\App\Models\Project::$status_color[$milestone->status]); ?> p-2 px-3 rounded">
                                                        ...
                                                        <div class="progress_wrapper">
                                                            ...
                                                            <div class="progress_labels">
                                                                <div class="total_progress">
                                                                    <strong>
                                                                        <?php if($milestone->progress): ?>
                                                                            <?php echo e($milestone->progress); ?>%
                                                                        <?php else: ?>
                                                                            0%
                                                                        <?php endif; ?>
                                                                    </strong>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <th scope="col" colspan="7">
                                                    <h6 class="text-center"><?php echo e(__('No milestone found')); ?></h6>
                                                </th>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                                ...
                                                <div class="col mb-3 mb-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="div">
                                                            ...
                                                            <small
                                                                class="text-muted"><?php echo e($attachment->file_size); ?></small>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <th scope="col" colspan="7">
                                                    <h6 class="text-center"><?php echo e(__('No Bug found')); ?></h6>
                                                </th>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <?php if(!empty($expense->attachment)): ?>
                                                            <a href="<?php echo e(asset(Storage::url($expense->attachment))); ?>"
                                                    ...
                                                    <td><?php echo e(!empty($expense->date) ? Utility::getDateFormated($expense->date) : '-'); ?>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <th scope="col" colspan="5">
                                                    <h6 class="text-center"><?php echo e(__('No Expense Found.')); ?></h6>
                                                </th>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                    ...
                    <div class="card  activity-scroll">
                        ...
                        <div class="card-body p-3 vertical-scroll-cards">
                            ...
                            <?php else: ?>
                                <tr>
                                    <th scope="col" colspan="7">
                                        <h6 class="text-center"><?php echo e(__('No activities found')); ?></h6>
                                    </th>
                                </tr>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.shareproject', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/projects/copylink.blade.php ENDPATH**/ ?>