<?php echo e(Form::model($indicator,array('route' => array('indicator.update', $indicator->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <h5><?php echo e($performances->name); ?></h5>
            <hr class="mt-0">
        </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/indicator/edit.blade.php ENDPATH**/ ?>