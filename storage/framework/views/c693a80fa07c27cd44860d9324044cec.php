...
<div class="row mb-4 gy-4">
    <div class="col-xxl-4 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link"><?php echo e(__('Total Companies')); ?></h2>
        ...
        <div class="info-card-inner card mb-0">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label">
                    ...
                    <span><?php echo e(env('CURRENCY_SYMBOL')); ?><?php echo e($user['total_orders_price']); ?></span>
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link"><?php echo e(__('Total Orders')); ?></h2>
    ...
    <div class="col-xxl-4 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link"><?php echo e(__('Total Plans')); ?></h2>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/super_admin.blade.php ENDPATH**/ ?>