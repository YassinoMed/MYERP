<?php echo e(Form::model($configurationItem, ['route' => ['configuration-items.update', $configurationItem->id], 'method' => 'PUT'])); ?>
...
<div class="col-md-3"><div class="form-group"><?php echo e(Form::label('status', __('Status'), ['class'=>'form-label'])); ?><?php echo e(Form::select('status', $statuses, $configurationItem->status, ['class'=>'form-control select'])); ?></div></div>
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('criticality', __('Criticality'), ['class'=>'form-label'])); ?><?php echo e(Form::select('criticality', $criticalities, $configurationItem->criticality, ['class'=>'form-control select'])); ?></div></div>
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('asset_id', __('Linked Asset'), ['class'=>'form-label'])); ?><?php echo e(Form::select('asset_id', $assets, $configurationItem->asset_id, ['class'=>'form-control select'])); ?></div></div>
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('owner_user_id', __('Owner'), ['class'=>'form-label'])); ?><?php echo e(Form::select('owner_user_id', $users, $configurationItem->owner_user_id, ['class'=>'form-control select'])); ?></div></div>
...
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('acquired_at', __('Acquired At'), ['class'=>'form-label'])); ?><?php echo e(Form::date('acquired_at', optional($configurationItem->acquired_at)->format('Y-m-d'), ['class'=>'form-control'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/configuration_items/edit.blade.php ENDPATH**/ ?>