...
<?php endif; ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('credit_limit',0,array('class'=>'form-control' , 'placeholder' => __('Enter Credit Limit'),'step'=>'0.01','min'=>'0'))); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::number('credit_score',0,array('class'=>'form-control' , 'placeholder' => __('0 to 100'),'min'=>'0','max'=>'100'))); ?>

            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group form-check form-switch mt-4 pt-2">
                <input type="checkbox" class="form-check-input" name="credit_hold" id="credit_hold">
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/customer/create.blade.php ENDPATH**/ ?>