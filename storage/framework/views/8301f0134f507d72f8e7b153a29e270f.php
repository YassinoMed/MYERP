<?php echo e(Form::open(['url' => 'managed-properties', 'method' => 'post', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?><?php echo e(Form::text('property_code', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        ...
        <div class="col-md-6"><div class="form-group"><?php echo e(Form::label('manager_employee_id', __('Manager'), ['class' => 'form-label'])); ?><?php echo e(Form::select('manager_employee_id', $employees, null, ['class' => 'form-control select'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/managed_properties/create.blade.php ENDPATH**/ ?>