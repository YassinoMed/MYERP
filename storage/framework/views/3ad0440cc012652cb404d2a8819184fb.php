                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-auto mt-4">
                                <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('report_payroll').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e($filterYear['type'].' '.__('Payroll Summary')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-12 mb-4">
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                <h5 class="mb-1"><?php echo e(__('Branch')); ?></h5>
                                <p class="text-muted mb-0"><?php echo e($filterYear['branch']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-12 mb-4">
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                <h5 class="mb-1"><?php echo e(__('Department')); ?></h5>
                                <p class="text-muted mb-0"><?php echo e($filterYear['department']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e($filterYear['dateYearRange']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Basic Salary')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalBasicSalary'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Net Salary')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalNetSalary'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Allowance')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalAllowance'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Commission')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalCommision'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Loan')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalLoan'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Saturation Deduction')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalSaturationDeduction'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Other Payment')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalOtherPayment'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Total Overtime')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($filterData['totalOverTime'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($payslip->status==0): ?>
                                            <div class="badge status_badge bg-danger p-2 px-3 rounded"><a href="#" class="text-white"><?php echo e(__('UnPaid')); ?></a></div>
                                        <?php else: ?>
                                            <div class="badge status_badge bg-success p-2 px-3 rounded"><a href="#" class="text-white"><?php echo e(__('Paid')); ?></a></div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/payroll.blade.php ENDPATH**/ ?>