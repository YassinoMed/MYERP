...
<?php endif; ?>
            <div class="form-icon-user">
                <?php echo e(Form::text('debit_note', !empty($debitNote->debitNote) ? \App\Models\CustomerDebitNotes::debitNumberFormat($debitNote->debitNote->debit_id) : '',array('class'=>'form-control ','required'=>'required' , 'disabled'))); ?>
...
</script><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/debitNote/edit.blade.php ENDPATH**/ ?>