                            ...
                            $.each(data, function(indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[7] != 0) {
                                    var payslip =
                                        ...
                                        id +
                                        '/' + datePicker +
                                        '" data-size="lg"  data-ajax-popup="true" class=" btn-sm btn btn-warning me-1" data-title="<?php echo e(__('Employee Payslip')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Payslip')); ?>" data-original-title="<?php echo e(__('Payslip')); ?>"><i class="ti ti-report-money"></i></a> ';
                                }
                                if (valueOfElement[6] == "UnPaid" && valueOfElement[7] != 0) {
                                    var clickToPaid =
                                        '<a href="<?php echo e(url('payslip/paysalary/')); ?>/' + id +
                                        '/' + datePicker +
                                        '"  class="btn-sm btn btn-primary me-1" "data-bs-toggle="tooltip" title="<?php echo e(__('Click To Paid')); ?>" data-original-title="<?php echo e(__('Click To Paid')); ?>"><i class="ti ti-currency-dollar"></i></a>  ';
                                } else {
                                    var clickToPaid = '';
                                }
                                ...
                                if (valueOfElement[7] != 0 && valueOfElement[6] == "UnPaid") {
                                    var edit =
                                        '<a href="#" data-url="<?php echo e(url('payslip/editemployee/')); ?>/' +
                                        payslip_id +
                                        '"  data-ajax-popup="true" class="btn-sm btn btn-info me-2" data-title="<?php echo e(__('Edit Employee salary')); ?>"data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>"><i class="ti ti-pencil text-white"></i></a>';
                                } else {
                                    var edit = '';
                                }
                                ...
                                <?php if(\Auth::user()->type != 'Employee'): ?>
                                    if (valueOfElement[7] != 0) {
                                        deleted = '<a href="#"  data-url="' + url +
                                            '" class="payslip_delete view-btn btn btn-danger btn-sm"   data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Delete')); ?>"><i class="ti ti-trash text-white"></i></a>';
                                    } else {
                                        deleted = '';
                                    }
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/payslip/index.blade.php ENDPATH**/ ?>