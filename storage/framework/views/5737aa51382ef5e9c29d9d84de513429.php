    ...
    <div class="row justify-content-between align-items-center mb-3">
        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
            <div class="all-button-box mx-2">
                <a href="<?php echo e(route('bill.pdf', \Crypt::encrypt($bill->id))); ?>" target="_blank"  class="btn btn-primary mt-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-end">
                                        <div class="me-4">
                                            <small>
                                                ...
                                                <?php echo e($user->dateFormat($bill->issue_date)); ?><br><br>
                                            </small>
                                        </div>
                                        <small>
                                            <strong><?php echo e(__('Due Date')); ?> :</strong><br>
                                            <?php echo e($user->dateFormat($bill->due_date)); ?><br><br>
                                        </small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <?php endif; ?>
                                    <div class="col">
                                        <div class="float-end mt-3">
                                            <?php if($company_setting['bill_qr_display'] == 'on'): ?>
                                ...
                                <div class="col">
                                    <small>
                                        ...
                                        <?php if($bill->status == 0): ?>
                                            <span class="badge bg-primary"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                        <?php elseif($bill->status == 1): ?>
                                            <span class="badge bg-warning"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                        <?php elseif($bill->status == 2): ?>
                                            <span class="badge bg-danger"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                        <?php elseif($bill->status == 3): ?>
                                            <span class="badge bg-info"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><b><?php echo e($user->priceFormat($totalDiscount)); ?></b></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-end"><?php echo e($user->priceFormat($bill->getSubTotal())); ?></td>
                                                </tr>

                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-end"><b><?php echo e(__('Discount')); ?></b></td>
                                                    <td class="text-end"><?php echo e($user->priceFormat($bill->getTotalDiscount())); ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="blue-text text-end"><?php echo e($user->priceFormat($bill->getTotal())); ?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-end"><b><?php echo e(__('Paid')); ?></b></td>
                                                    <td class="text-end"><?php echo e($user->priceFormat(($bill->getTotal()-$bill->getDue())-($bill->billTotalDebitNote()))); ?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-end"><b><?php echo e(__('Debit Note')); ?></b></td>
                                                    <td class="text-end"><?php echo e($user->priceFormat(($bill->billTotalDebitNote()))); ?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-end"><b><?php echo e(__('Due')); ?></b></td>
                                                    <td class="text-end"><?php echo e($user->priceFormat($bill->getDue())); ?></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/bill/customer_bill.blade.php ENDPATH**/ ?>