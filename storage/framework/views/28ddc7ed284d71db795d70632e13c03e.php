                                ...
                                <div class="col-md-3">
                                    <div class="card-body px-0">
                                        ...
                                        <form id="setting-form" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label for="address"
                                                            class="col-form-label pt-0"><?php echo e(__('Proposal Template')); ?></label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="address"
                                                            class="col-form-label pt-0"><?php echo e(__('QR Display?')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label pt-0"><?php echo e(__('Color Input')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label pt-0"><?php echo e(__('Proposal Logo')); ?></label>
                                        ...
                                        <form id="setting-form" method="post" action="<?php echo e(route('template.setting')); ?>"
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label for="address"
                                                            class="col-form-label pt-0"><?php echo e(__('Invoice Template')); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label pt-0"><?php echo e(__('Invoice Logo')); ?></label>
                                                <div class="choose-files">
                                ...
                                <div class="col-md-3">
                                    <div class="card-body px-0">
                                        ...
                                        <form id="setting-form" method="post"
                                            ...
                                            <div class="form-group">
                                                <label class="col-form-label pt-0"><?php echo e(__('Bill Logo')); ?></label>
                                                <div class="choose-files">
                                                    <label for="bill_logo">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/settings/print.blade.php ENDPATH**/ ?>