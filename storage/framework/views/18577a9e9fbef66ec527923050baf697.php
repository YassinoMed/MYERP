                    ...
                    <div class="row timeline-wrapper">
                        <div class="col-xl-4 col-md-5 col-sm-7 create-invoice invoice">
                            ...
                            <div class="bill-timeline-inner d-flex gap-3">
                                ...
                                <div class="timeline-content text-start">
                                    <h5 class="mb-2"><?php echo e(__('Create Purchase')); ?></h5>
                                    <p class="text-muted mb-2"><?php echo e(__('Created on ')); ?><?php echo e(\Auth::user()->dateFormat($purchase->purchase_date)); ?></p>
                        ...
                        <div class="col-xl-4 col-md-5 col-sm-7 send-invoice invoice">
                            ...
                            <div class="bill-timeline-inner d-flex gap-3">
                                ...
                                <div class="timeline-content text-start">
                                    <h5 class="mb-2"><?php echo e(__('Send Purchase')); ?></h5>
                                    <p class="text-muted mb-2">
                                        <?php if($purchase->status != 0): ?>
                                            <?php echo e(__('Sent on')); ?> <?php echo e(\Auth::user()->dateFormat($purchase->send_date)); ?>
                                    ...
                                    <?php if($purchase->status == 0): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('send purchase')): ?>
                                            <a href="<?php echo e(route('purchase.sent', $purchase->id)); ?>" class="btn btn-sm d-inline-flex align-items-center gap-2 btn-warning border-0"
                                ...
                                <div class="timeline-content text-start">
                                    ...
                                    <?php if($purchase->status != 0): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create payment purchase')): ?>
                                            <a href="#" data-url="<?php echo e(route('purchase.payments', $purchase->id)); ?>"
                                                ...
                                                class="btn btn-sm d-inline-flex align-items-center gap-2" data-original-title="<?php echo e(__('Add Payment')); ?>"><i
                                                    class="ti ti-report-money mr-2"></i><?php echo e(__('Add Payment')); ?></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="float-end mt-3">
                                        <?php if($settings['pos_purchase_qr_display'] == 'on'): ?>
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php $__empty_0 = true; $__currentLoopData = $purchase->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                <tr>
                                    <td>
                                        <?php if(!empty($payment->add_receipt)): ?>
                                            <a href="<?php echo e(asset(Storage::url('uploads/payment')).'/'.$payment->add_receipt); ?>" download="" class="btn btn-sm btn-secondary btn-icon " target="_blank"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Download')); ?>"><span class="btn-inner--icon"><i class="ti ti-download"></i></span></a>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/purchase/view.blade.php ENDPATH**/ ?>