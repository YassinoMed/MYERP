<?php echo e(Form::open(['route' => 'patients.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
                <?php echo e(Form::text('first_name', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter first name')])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::text('last_name', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter last name')])); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('cin', null, ['class' => 'form-control', 'placeholder' => __('Enter CIN')])); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('cnam_number', null, ['class' => 'form-control', 'placeholder' => __('Enter CNAM number')])); ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('blood_group', null, ['class' => 'form-control', 'placeholder' => __('Enter blood group')])); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('address', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter address')])); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('allergies', null, ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter allergies')])); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('medical_history', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Enter medical history')])); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('current_treatments', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('Enter current treatments')])); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('emergency_contact_name', null, ['class' => 'form-control', 'placeholder' => __('Enter contact name')])); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('emergency_contact_phone', null, ['class' => 'form-control', 'placeholder' => __('Enter contact phone')])); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('emergency_contact_relationship', null, ['class' => 'form-control', 'placeholder' => __('Enter relationship')])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/patient/create.blade.php ENDPATH**/ ?>