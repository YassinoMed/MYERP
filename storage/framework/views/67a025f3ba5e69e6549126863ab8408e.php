...
<?php $component = App\View\Components\Mobile::resolve(['label' => ''.e(__('Phone')).'','name' => 'phone','value' => ''.e($employee->phone).'','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholdeer' => 'Enter employee phone']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                    <?php echo e(Form::select('branch_id', $branches, $employee->branch_id, ['class' => 'form-control select', 'required' => 'required', 'id' => 'branch_id'])); ?>
...
<?php endif; ?>
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('designation_id', __('Designation'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                    <?php echo e(Form::select('designation_id', $designations, null, ['class' => 'form-control select', 'required' => 'required', 'id' => 'designation_id'])); ?>
                                        ...
                                        <div class="float-right col-4">
                                            ...
                                            <div class="choose-file">
                                                <label for="document[<?php echo e($document->id); ?>]">
                                                    <input
                                                        class="form-control file-validate <?php if(!empty($employeedoc[$document->id])): ?> float-left <?php endif; ?> <?php $__errorArgs = ['document'];
...
unset($__errorArgs, $__bag); ?> "
                                                        ...
                                                        type="file" data-filename="<?php echo e($document->id . '_filename'); ?>">
                        ...
                        <div class="card-body employee-detail-edit-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::number('account_number', null, [
                                        'class' => 'form-control',
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::text('bank_name', null, ['class' => 'form-control', 'placeholder' => __('Enter bank name')]); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::text('tax_payer_id', null, ['class' => 'form-control', 'placeholder' => __('Enter tax payer id')]); ?>
        ...
        <?php if(\Auth::user()->type != 'employee'): ?>
            <div class="float-end">
                <input type="button" value="<?php echo e(__('Cancel')); ?>"
                    onclick="location.href = '<?php echo e(route('employee.index')); ?>';" class="btn btn-secondary me-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/employee/edit.blade.php ENDPATH**/ ?>