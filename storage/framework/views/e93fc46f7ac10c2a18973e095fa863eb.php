...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <?php echo e(Form::open(array('route'=>array('job.on.board.convert',$jobOnBoard->id),'method'=>'post','enctype'=>'multipart/form-data'))); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <?php echo Form::date('dob', !empty($jobOnBoard->applications)?$jobOnBoard->applications->dob:'', ['class' => 'form-control datepicker']); ?>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="d-flex radio-check mt-2">
                                    <div class="form-check form-check-inline form-group">
                                        <input type="radio" id="g_male" value="Male" name="gender" class="form-check-input" <?php echo e((!empty($jobOnBoard->applications) && $jobOnBoard->applications->gender=='Male')?'checked':''); ?>>
                                        <label class="form-check-label" for="g_male"><?php echo e(__('Male')); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline form-group">
                                        <input type="radio" id="g_female" value="Female" name="gender" class="form-check-input" <?php echo e((!empty($jobOnBoard->applications) && $jobOnBoard->applications->gender=='Female')?'checked':''); ?>>
                ...
                <div class="card-body employee-detail-create-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <?php echo e(Form::select('branch_id', $branches,!empty($jobOnBoard->applications)?!empty($jobOnBoard->applications->jobs)?$jobOnBoard->applications->jobs->branch:'':'', array('class' => 'form-control ','required'=>'required'))); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class=" form-control " id="designation_id" name="designation_id" data-toggle="select2" data-placeholder="<?php echo e(__('Select Designation ...')); ?>">
                        ...
                        <div class="form-group col-md-12 ">
                            ...
                            <?php echo Form::date('company_doj', $jobOnBoard->joining_date, ['class' => 'form-control datepicker','required' => 'required']); ?>
...
unset($__errorArgs, $__bag); ?> border-0" <?php if($document->is_required == 1): ?> required <?php endif; ?> name="document[<?php echo e($document->id); ?>]" type="file" id="document[<?php echo e($document->id); ?>]" data-filename="<?php echo e($document->id.'_filename'); ?>">
    ...
    <div class="row">
        <div class="col-12 text-end" >
            <?php echo Form::submit('Create', ['class' => 'btn btn-primary radius-10px']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/jobApplication/convert.blade.php ENDPATH**/ ?>