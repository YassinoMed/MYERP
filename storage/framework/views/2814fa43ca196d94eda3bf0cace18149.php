<?php echo e(Form::open(['route' => 'pharmacy-medications.store', 'method' => 'post'])); ?>
...
<?php endif; ?><?php echo e(Form::text('name', null, ['class' => 'form-control', 'required' => 'required'])); ?></div>
    ...
    <div class="col-md-4 mt-2"><?php echo e(Form::label('expiry_date', __('Expiry Date'), ['class' => 'form-label'])); ?><?php echo e(Form::date('expiry_date', null, ['class' => 'form-control'])); ?></div>
    <div class="col-md-4 mt-2"><?php echo e(Form::label('unit_price', __('Unit Price'), ['class' => 'form-label'])); ?><?php echo e(Form::number('unit_price', 0, ['class' => 'form-control', 'step' => '0.01'])); ?></div>
    <div class="col-md-6 mt-2"><?php echo e(Form::label('stock_quantity', __('Stock Quantity'), ['class' => 'form-label'])); ?><?php echo e(Form::number('stock_quantity', 0, ['class' => 'form-control', 'step' => '0.01'])); ?></div>
    <div class="col-md-6 mt-2"><?php echo e(Form::label('reorder_level', __('Reorder Level'), ['class' => 'form-label'])); ?><?php echo e(Form::number('reorder_level', 0, ['class' => 'form-control', 'step' => '0.01'])); ?></div>
</div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pharmacy_medication/create.blade.php ENDPATH**/ ?>