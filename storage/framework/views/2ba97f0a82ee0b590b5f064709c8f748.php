<?php echo e(Form::open(['url' => 'data-consents', 'method' => 'post'])); ?>
...
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('status', __('Status'), ['class'=>'form-label'])); ?><?php echo e(Form::select('status', $statuses, 'granted', ['class'=>'form-control select'])); ?></div></div>
<div class="col-md-4"><div class="form-group"><?php echo e(Form::label('consented_at', __('Consented At'), ['class'=>'form-label'])); ?><?php echo e(Form::date('consented_at', now()->format('Y-m-d'), ['class'=>'form-control'])); ?></div></div>
<div class="col-md-6"><div class="form-group"><?php echo e(Form::label('expires_at', __('Expires At'), ['class'=>'form-label'])); ?><?php echo e(Form::date('expires_at', null, ['class'=>'form-control'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/data_consents/create.blade.php ENDPATH**/ ?>