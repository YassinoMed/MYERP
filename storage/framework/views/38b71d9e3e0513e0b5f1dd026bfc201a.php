<?php echo e(Form::model($innovationIdea, ['route' => ['innovation-ideas.update', $innovationIdea->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?><?php echo e(Form::text('title', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        ...
        <div class="col-md-6"><div class="form-group"><?php echo e(Form::label('submitted_by', __('Submitted By'), ['class' => 'form-label'])); ?><?php echo e(Form::select('submitted_by', $employees, $innovationIdea->submitted_by, ['class' => 'form-control select'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::select('priority', $priorities, $innovationIdea->priority, ['class' => 'form-control select', 'required' => 'required'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::select('status', $statuses, $innovationIdea->status, ['class' => 'form-control select', 'required' => 'required'])); ?></div></div>
        <div class="col-md-6"><div class="form-group"><?php echo e(Form::label('expected_value', __('Expected Value'), ['class' => 'form-label'])); ?><?php echo e(Form::number('expected_value', null, ['class' => 'form-control', 'step' => '0.0001'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/innovation_ideas/edit.blade.php ENDPATH**/ ?>