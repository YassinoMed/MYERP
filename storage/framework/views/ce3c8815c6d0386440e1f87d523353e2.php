<?php echo e(Form::model($subsidiary, ['route' => ['subsidiaries.update', $subsidiary->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?><?php echo e(Form::text('name', null, ['class' => 'form-control', 'required' => 'required'])); ?></div></div>
        ...
        <div class="col-md-6"><div class="form-group"><?php echo e(Form::label('ownership_percentage', __('Ownership %'), ['class' => 'form-label'])); ?><?php echo e(Form::number('ownership_percentage', null, ['class' => 'form-control', 'step' => '0.0001'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::select('consolidation_method', $methods, $subsidiary->consolidation_method, ['class' => 'form-control select', 'required' => 'required'])); ?></div></div>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?><?php echo e(Form::select('status', $statuses, $subsidiary->status, ['class' => 'form-control select', 'required' => 'required'])); ?></div></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/subsidiaries/edit.blade.php ENDPATH**/ ?>