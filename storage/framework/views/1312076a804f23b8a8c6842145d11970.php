<?php echo e(Form::open(array('url'=>'trainer','method'=>'post', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php $component = App\View\Components\Mobile::resolve(['label' => ''.e(__('Contact')).'','name' => 'contact','value' => ''.e(old('contact')).'','required' => true,'placeholder' => ''.e(__('Enter Contact')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/trainer/create.blade.php ENDPATH**/ ?>