            ...
            <div class="my-3 d-flex justify-content-end">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create allowance option')): ?>
                    <a href="#" data-url="<?php echo e(route('allowanceoption.create')); ?>" data-ajax-popup="true"
                        data-title="<?php echo e(__('Create New Allowance Option')); ?>" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/allowanceoption/index.blade.php ENDPATH**/ ?>