<?php echo e(Form::open(['url' => 'production/work-centers', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('type', ['machine' => __('Machine'), 'workshop' => __('Workshop'), 'employee' => __('Employee')], 'machine', ['class' => 'form-control', 'required' => 'required'])); ?>
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::number('cost_per_hour', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('capacity_hours_per_day', __('Capacity Hours / Day'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('capacity_hours_per_day', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('capacity_workers', __('Capacity Workers'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('capacity_workers', 0, ['class' => 'form-control', 'min' => 0])); ?>

        </div>
        <div class="form-group col-md-12">
            <div class="form-check form-switch mt-2">
                <input class="form-check-input" type="checkbox" name="is_bottleneck" id="is_bottleneck">
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/production/work_centers/create.blade.php ENDPATH**/ ?>