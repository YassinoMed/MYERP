                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Transaction Summary')); ?>
                    ...
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <p class="text-muted mb-0"><?php echo e($filter['account']); ?>
                    ...
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <?php endif; ?>
                                <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($account->total)); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/transaction/index.blade.php ENDPATH**/ ?>