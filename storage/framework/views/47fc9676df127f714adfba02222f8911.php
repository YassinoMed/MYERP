...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end">
        <a href="#" data-size="md" class="btn btn-primary btn-sm d-inline-flex align-items-center gap-2" data-ajax-popup-over="true" data-url="<?php echo e(route('generate',['journal entry'])); ?>"
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo e(Form::model($journalEntry, array('route' => array('journal-entry.update', $journalEntry->id), 'method' => 'PUT','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?></th>
    ...
    <div class="modal-footer d-flex align-items-center gap-2 mb-3">
        <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route('journal-entry.index')); ?>';" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/journalEntry/edit.blade.php ENDPATH**/ ?>