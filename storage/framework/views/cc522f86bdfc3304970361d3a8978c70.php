...
<body>
                            ...
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <?php echo e(Utility::purchaseNumberFormat($settings, $purchase->purchase_id)); ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo e(__('Purchase Date')); ?>:</td>
                                        <td class="text-right">
                                            <?php echo e(Utility::dateFormat($settings, $purchase->purchase_date)); ?></td>
                                    </tr>
                                    ...
                                    <?php if(!empty($customFields) && count($purchase->customField) > 0): ?>
                                        <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td> <?php echo e(!empty($purchase->customField) ? $purchase->customField[$field->id] : '-'); ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    <td><?php echo e(__('Total')); ?>:</td>
                                    <td><?php echo e(Utility::priceFormat($settings, $purchase->getSubTotal() - $purchase->getTotalDiscount() + $purchase->getTotalTax())); ?>

                                    </td>
                                </tr>
                                <tr>
                                    <td><?php echo e(__('Paid')); ?>:</td>
                                    <td><?php echo e(Utility::priceFormat($settings, $purchase->getTotal() - $purchase->getDue())); ?>
    ...
    <?php if(!isset($preview)): ?>
        <?php echo $__env->make('purchase.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>;
    <?php endif; ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/purchase/templates/template10.blade.php ENDPATH**/ ?>