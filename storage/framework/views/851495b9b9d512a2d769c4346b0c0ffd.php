<?php echo e(Form::model($customer,array('route' => array('customer.update', $customer->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php $component = App\View\Components\Mobile::resolve(['label' => ''.e(__('Contact')).'','name' => 'contact','value' => ''.e($customer->contact).'','required' => true,'placeholder' => 'Enter Contact'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('credit_limit',__('Credit Limit'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('credit_limit',null,array('class'=>'form-control' , 'placeholder' => __('Enter Credit Limit'),'step'=>'0.01','min'=>'0'))); ?>

            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <?php echo e(Form::label('credit_score',__('Credit Score'),['class'=>'form-label'])); ?>

                <?php echo e(Form::number('credit_score',null,array('class'=>'form-control' , 'placeholder' => __('0 to 100'),'min'=>'0','max'=>'100'))); ?>

            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group form-check form-switch mt-4 pt-2">
                <input type="checkbox" class="form-check-input" name="credit_hold" id="credit_hold" <?php echo e(($customer->credit_hold ?? 0) == 1 ? 'checked' : ''); ?>>
                <label class="form-check-label" for="credit_hold"><?php echo e(__('Block On Credit Limit')); ?></label>
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
                <?php echo e(Form::label('guarantee_notes',__('Guarantees / Notes'),['class'=>'form-label'])); ?>

                <?php echo e(Form::textarea('guarantee_notes',null,array('class'=>'form-control','rows'=>2 , 'placeholder' => __('Guarantees, caution, payment terms...')))); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('billing_zip',null,array('class'=>'form-control', 'placeholder' => __('Enter Zip')))); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/customer/edit.blade.php ENDPATH**/ ?>