...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="text-end">
                                                <button class="btn btn-sm btn-primary btn-icon m-1 " data-repeater-create type="button" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create')); ?>"><i class="ti ti-plus"></i></button>
                                                </div>
                                                            ...
                                                            <div class="px-2 py-2">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto actions">
                                                                        <a data-repeater-delete href="javascript:void(0)" class="action-item btn btn-sm btn-icon btn-danger repeater-action-btn ms-2" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-title="<?php echo e(__('Delete')); ?>">
                                                    ...
                                                    <div class="card mb-3 border shadow-none product_Image">
                                                        <div class="px-2 py-2">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-auto actions">
                                                                    <a class="action-item btn btn-sm btn-icon btn-primary" href="<?php echo e($logo.'/'.$home_logo); ?>" download="" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Download')); ?>">
                                                                        <i class="ti ti-download text-white"></i>
                                                                    </a>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a class="action-item btn btn-sm btn-icon btn-danger delete-button" data-image="<?php echo e($home_logo); ?>" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Delete')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/Modules/LandingPage/Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>