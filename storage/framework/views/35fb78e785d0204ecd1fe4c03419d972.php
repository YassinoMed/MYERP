                                            ...
                                            <tr>
                                                ...
                                                <td class="border-0">
                                                    ...
                                                    <?php if($project->status == 'in_progress'): ?>
                                                        <div class="badge status_badge bg-primary p-2 px-3 rounded"> <?php echo e(__('In Progress')); ?></div>
                                                    <?php elseif($project->status == 'on_hold'): ?>
                                                    <div class="badge status_badge bg-secondary p-2 px-3 rounded"><?php echo e(__('On Hold')); ?></div>
                                                    <?php elseif($project->status == 'Canceled'): ?>
                                                    <div class="badge status_badge bg-danger p-2 px-3 rounded"> <?php echo e(__('Canceled')); ?></div>
                                                    <?php else: ?>
                                                        <div class="badge status_badge bg-warning p-2 px-3 rounded"><?php echo e(__('Finished')); ?></div>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                     ...
                                     <tbody>
                                           <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               <td> <?php if($milestone->status == 'complete'): ?>
                                                                    <label class="status_badge badge bg-success p-2 px-3 rounded"><?php echo e(__('Complete')); ?></label>
                                                                <?php else: ?>
                                                       <label class="status_badge badge bg-warning p-2 px-3 rounded"><?php echo e(__('Incomplete')); ?></label>
                                                   <?php endif; ?></td>
                                                ...
                                                <div class="avatar-group">
                                                    <?php if($task->users()->count() > 0): ?>
                                                            ...
                                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($key<3): ?>
                                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                                        <img src="<?php echo e($user->getImgImageAttribute()); ?>" title="<?php echo e($user->name); ?>" alt="avtar-image">
                                                                    </a>
                                                                <?php else: ?>
                                                                    <?php break; ?>
                                                                <?php endif; ?>
                                                        ...
                                                        <?php if(count($users) > 3): ?>
                                                            <a href="#" class="avatar rounded-circle avatar-sm">
                                                                <img src="<?php echo e($user->getImgImageAttribute()); ?>" alt="avtar-image">
                                                            </a>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <?php echo e(__('-')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/project_report/show.blade.php ENDPATH**/ ?>