...
<div class="float-end">
    ...
    <div class="float-end me-2" id="filter">
        <button id="filter" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="<?php echo e(__('Filter')); ?>"><i class="ti ti-filter"></i></button>
    </div>
                                        ...
                                        <table class="table pc-dt-simple" id="report-vendor-balance">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $total = 0;
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $resultArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payableVendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                            ...
                                                            $total += $balance;
                                                        ?>
                                                        <td> <?php echo e($payableVendor['name']); ?></td>
                                                        <td> <?php echo e(\Auth::user()->priceFormat($vendorBalance)); ?> </td>
                                                        <td> <?php echo e(!empty($payableVendor['debit_price']) ? \Auth::user()->priceFormat($payableVendor['debit_price']) : \Auth::user()->priceFormat(0)); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table pc-dt-simple" id="report-payable-summary">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $payableSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payableSummary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <td> <?php echo $payableSummary['name'] ? $payableSummary['name'] : '<span class="p-2 px-3">-</span>'; ?></td>
                                                        ...
                                                        <td>
                                                            <?php if($payableSummary['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableSummary['status']])); ?></span>
                                                            <?php elseif($payableSummary['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableSummary['status']])); ?></span>
                                                            <?php elseif($payableSummary['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableSummary['status']])); ?></span>
                                                            <?php elseif($payableSummary['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableSummary['status']])); ?></span>
                                                            <?php elseif($payableSummary['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableSummary['status']])); ?></span>
                                                            <?php else: ?>
                                                                <span class="p-2 px-3">-</span>
                                                            <?php endif; ?>
                                                        </td>
                                                        <?php if($payableSummary['bill']): ?>
                                                            <td><?php echo e(__('Bill')); ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table pc-dt-simple" id="report-payable-details">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $payableDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payableDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <td> <?php echo $payableDetail['name'] ? $payableDetail['name'] : '<span class="p-2 px-3">-</span>'; ?></td>
                                                        ...
                                                        <td>
                                                            <?php if($payableDetail['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableDetail['status']])); ?></span>
                                                            <?php elseif($payableDetail['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableDetail['status']])); ?></span>
                                                            <?php elseif($payableDetail['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableDetail['status']])); ?></span>
                                                            <?php elseif($payableDetail['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableDetail['status']])); ?></span>
                                                            <?php elseif($payableDetail['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$payableDetail['status']])); ?></span>
                                                            <?php else: ?>
                                                                <span
                                                                    class="p-2 px-3">-</span>
                                                            <?php endif; ?>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                    <tr>
                                                        <td colspan="9" class="text-center"><?php echo e(__('No Data Found.!')); ?></td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <table class="table pc-dt-simple" id="report-payable-details">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $total = 0;
                                                ?>
                                                <?php $__empty_2 = true; $__currentLoopData = $agingSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $agingSummary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->priceFormat($agingSummary['greater_than_45_days'])); ?></td>
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $moreThan45; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->billNumberFormat($value['bill_id'])); ?>
                                                        ...
                                                        <td>
                                                            <?php if($value['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$value['status']])); ?></span>
                                                            <?php elseif($value['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$value['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                ...
                                                <?php $__currentLoopData = $days31to45; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day31to45): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->billNumberFormat($day31to45['bill_id'])); ?>
                                                        ...
                                                        <td>
                                                            <?php if($day31to45['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day31to45['status']])); ?></span>
                                                            <?php elseif($day31to45['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day31to45['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                ...
                                                <?php $__currentLoopData = $days16to30; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day16to30): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->billNumberFormat($day16to30['bill_id'])); ?>
                                                        ...
                                                        <td>
                                                            <?php if($day16to30['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day16to30['status']])); ?></span>
                                                            <?php elseif($day16to30['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day16to30['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                ...
                                                <?php $__currentLoopData = $days1to15; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day1to15): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->billNumberFormat($day1to15['bill_id'])); ?>
                                                        ...
                                                        <td>
                                                            <?php if($day1to15['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day1to15['status']])); ?></span>
                                                            <?php elseif($day1to15['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$day1to15['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                ...
                                                <?php $__currentLoopData = $currents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $current): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Auth::user()->billNumberFormat($current['bill_id'])); ?>
                                                        ...
                                                        <td>
                                                            <?php if($current['status'] == 0): ?>
                                                                <span
                                                                    class="status_badge badge bg-secondary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 1): ?>
                                                                <span
                                                                    class="status_badge badge bg-warning p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 2): ?>
                                                                <span
                                                                    class="status_badge badge bg-danger p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 3): ?>
                                                                <span
                                                                    class="status_badge badge bg-info p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$current['status']])); ?></span>
                                                            <?php elseif($current['status'] == 4): ?>
                                                                <span
                                                                    class="status_badge badge bg-primary p-2 px-3"><?php echo e(__(\App\Models\Bill::$statues[$current['status']])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/payable_report.blade.php ENDPATH**/ ?>