                        ...
                        <?php echo e(Form::open(['route' => ['project_report.index'], 'method' => 'GET', 'id' => 'project_report_submit'])); ?>
                            ...
                            <div class="row d-flex align-items-center justify-content-end">
                                ...
                                <div class="col-auto float-end ms-2 mt-4">
                                    ...
                                    <a href="<?php echo e(route('project_report.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                        ...
                        <?php if(isset($projects) && !empty($projects) && count($projects) > 0): ?>
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                        ...
                                        <div class="avatar-group" id="project_<?php echo e($project->id); ?>">
                                            <?php if(isset($project->users) && !empty($project->users) && count($project->users) > 0): ?>
                                                ...
                                                <?php if(count($project->users) > 3): ?>
                                                    <a href="#" class="avatar project-image-item rounded-circle">
                                                        <span>+ <?php echo e(count($project->users)-3); ?></span>
                                    ...
                                    <td>
                                        <h6 class="mb-1 text-success"><?php echo e($project->project_progress($project,$last_task->id)['percentage']); ?></h6>
                                    ...
                                    <td class="">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                                            <div class="action-btn me-2">
                                                <a href="<?php echo e(route('project_report.show', $project->id)); ?>" class="mx-3 btn btn-sm align-items-center bg-warning" data-bs-toggle="tooltip" title="<?php echo e(__('View Project Report')); ?>" data-original-title="<?php echo e(__('Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/project_report/index.blade.php ENDPATH**/ ?>