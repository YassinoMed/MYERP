...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($purchase, array('route' => array('purchase.update', $purchase->id), 'method' => 'PUT','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php endif; ?>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='<?php echo e(json_encode($purchase->items)); ?>'>
...
<?php endif; ?></th>
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <div class="form-group">
                                        <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>route('purchase.product'), 'required' => 'required'))); ?>
                                ...
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::number('price',null, array('class' => 'form-control price','required'=>'required','placeholder'=>__('Price'),'required'=>'required', 'step' => '0.01'))); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/purchase/edit.blade.php ENDPATH**/ ?>