<?php echo e(Form::model($service, ['route' => ['medical-services.update', $service->id], 'method' => 'put'])); ?>
...
<?php endif; ?><?php echo e(Form::text('name', null, ['class' => 'form-control', 'required' => 'required'])); ?></div>
    ...
    <div class="col-md-6 mt-2"><?php echo e(Form::label('price', __('Price'), ['class' => 'form-label'])); ?><?php echo e(Form::number('price', null, ['class' => 'form-control', 'step' => '0.01', 'min' => '0'])); ?></div>
    <div class="col-md-6 mt-2"><?php echo e(Form::label('default_coverage_rate', __('Default Coverage %'), ['class' => 'form-label'])); ?><?php echo e(Form::number('default_coverage_rate', null, ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'max' => '100'])); ?></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/medical_service/edit.blade.php ENDPATH**/ ?>