            ...
            <div class="my-3 d-flex justify-content-end">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create goal type')): ?>
                    <a href="#" data-url="<?php echo e(route('goaltype.create')); ?>" data-ajax-popup="true"
                        data-title="<?php echo e(__('Create New Goal Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit goal type')): ?>
                                                        <div class="action-btn me-2">
                                                            <a href="#" class="mx-3 btn btn-sm align-items-center bg-info"
                                                                data-url="<?php echo e(URL::to('goaltype/' . $goaltype->id . '/edit')); ?>"
                                                                data-ajax-popup="true" data-title="<?php echo e(__('Edit Goal Type')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/goaltype/index.blade.php ENDPATH**/ ?>