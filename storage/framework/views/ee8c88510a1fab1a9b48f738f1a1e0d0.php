...
<body class="<?php echo e($themeColor); ?>">
            ...
            <div class="col-lg-5 ps-lg-0">
                <div class="card m-0 h-100">
                    <div class="card-header p-2">
                        <div class="row gy-2">
                            <div class="col-sm-6">
                                <?php echo e(Form::select('customer_id', $customers, $customer, ['class' => 'form-control select customer_select', 'id' => 'customer', 'required' => 'required', 'placeholder' => __('Select Customer') ])); ?>
                                                ...
                                                <td>
                                                    <span class="quantity buttons_added">
                                                        ...
                                                        <input type="number" step="1" min="1"
                                                            ...
                                                            value="<?php echo e($details['quantity']); ?>" placeholder="<?php echo e(__('Enter Quantity')); ?>">
                                ...
                                <div class="d-flex flex-column flex-sm-row justify-content-between gap-3">
                                    <div class="sub-total-left flex-1" id="btn-pur">
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-12">
                                                <input type="text" class="form-control pos-coupon-code"
                                                    id="pos_coupon_code" placeholder="<?php echo e(__('Code promo')); ?>">
                                            </div>
                                            <div class="col-6">
                                                <input type="number" min="0"
                                                    class="form-control pos-loyalty-points" id="pos_loyalty_points"
                                                    placeholder="<?php echo e(__('Points fidélité')); ?>">
                                            </div>
                                            <div class="col-6">
                                                <input type="number" min="0"
                                                    class="form-control pos-cross-sell-discount"
                                                    id="pos_cross_sell_discount" placeholder="<?php echo e(__('Remise cross-sell %')); ?>">
                                            </div>
                                            <div class="col-6">
                                                <input type="number" min="0" class="form-control pos-buy-x"
                                                    id="pos_buy_x" placeholder="<?php echo e(__('Acheter X')); ?>">
                                            </div>
                                            <div class="col-6">
                                                <input type="number" min="0" class="form-control pos-get-y"
                                                    id="pos_get_y" placeholder="<?php echo e(__('Offert Y')); ?>">
                                            </div>
                                            <div class="col-12">
                                                <input type="number" min="0"
                                                    class="form-control pos-cross-sell-product"
                                                    id="pos_cross_sell_product_id"
                                                    placeholder="<?php echo e(__('Produit cross-sell (ID)')); ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="sub-total-right flex-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-sm-end mb-2">
                                            <h6 class="mb-0 text-dark"><?php echo e(__('Promotion')); ?> :</h6>
                                            <h6 class="mb-0 text-dark" id="promo_discount_display">
                                                <?php echo e(Auth::user()->priceFormat(0)); ?></h6>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-sm-end mb-3">
                                            <h6 class="mb-0 text-dark"><?php echo e(__('Total')); ?> :</h6>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            function applyPosPromotions() {
                var discount = $('.discount').val();
                var payload = {
                    discount: discount,
                    coupon_code: $('#pos_coupon_code').val(),
                    loyalty_points: $('#pos_loyalty_points').val(),
                    buy_x: $('#pos_buy_x').val(),
                    get_y: $('#pos_get_y').val(),
                    cross_sell_product_id: $('#pos_cross_sell_product_id').val(),
                    cross_sell_discount: $('#pos_cross_sell_discount').val()
                };
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (typeof data.discount_total !== 'undefined') {
                            $('#discount_hidden').val(data.discount_total);
                        }
                        if (typeof data.promo_discount_formatted !== 'undefined') {
                            $('#promo_discount_display').text(data.promo_discount_formatted);
                        }
                    },
                    error: function (data) {
            ...
            $(document).on('keyup change', '#pos_coupon_code, #pos_loyalty_points, #pos_buy_x, #pos_get_y, #pos_cross_sell_product_id, #pos_cross_sell_discount', function () {
                applyPosPromotions();
            });
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/index.blade.php ENDPATH**/ ?>