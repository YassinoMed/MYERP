...
<div class="row">
    ...
    <div class="col-lg-5 mb-4">
        <div class="card h-100 mb-0">
            <div class="card-header">
                <h5><?php echo e(__('Upcoming Events')); ?></h5>
            </div>
                ...
                <div class="event-wrp">
                    <?php if(!$events->isEmpty()): ?>
                        <?php $__currentLoopData = $current_month_event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="event-item d-flex align-items-center <?php echo e($event->color); ?>">
                                <div class="event-content flex-1">
                                    <h6 class="mb-2">
                                        <a href="#" data-size="lg" data-url="<?php echo e(route('event.edit',$event->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Event')); ?>" class="dashboard-link"><?php echo e($event->title); ?></a>
                                    </h6>
                                    <div class="date-wrp d-flex flex-wrap align-items-center">
                                        <div class="date">
                                            <span class="f-w-600"><?php echo e(__('Start Date : ')); ?></span><?php echo e(\Auth::user()->dateFormat($event->start_date)); ?>

                                        </div>
                                        <div class="date">
                                            <span class="f-w-600"><?php echo e(__('End Date : ')); ?></span><?php echo e(\Auth::user()->dateFormat($event->end_date)); ?>

                                        </div>
                                    </div>
                                </div>
                                <div class="action-btns d-flex flex-column gap-2">
                                    <a href="#" data-url="<?php echo e(route('event.edit',$event->id)); ?>" data-title="<?php echo e(__('Edit Event')); ?>" data-ajax-popup="true" class="btn btn-sm bg-info shadow-sm d-flex" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
                                        <i class="ti ti-pencil text-white"></i>
                                    </a>
                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['event.destroy', $event->id],'id'=>'delete-form-'.$event->id]); ?>

                                        <a href="#" class="btn btn-sm bs-pass-para bg-danger shadow-sm d-flex" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-form-<?php echo e($event->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/event/index.blade.php ENDPATH**/ ?>