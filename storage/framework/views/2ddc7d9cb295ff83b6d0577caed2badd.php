...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('support.grid')); ?>" class="btn btn-sm btn-primary-subtle me-1" data-bs-toggle="tooltip"
            title="<?php echo e(__('Grid View')); ?>">
            <i class="ti ti-layout-grid text-white"></i>
        </a>
        <a href="#" data-size="lg" data-url="<?php echo e(route('support.create')); ?>" data-ajax-popup="true"
            data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create Support')); ?>"
        ...
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 support-ticket-card">
            <div class="support-card-inner d-flex align-items-start gap-3">
                ...
                <div class="support-content flex-1">
                    ...
                    <h2 class="h5 mb-0"><?php echo e(__('Ticket')); ?></h2>
                </div>
                <h3 class="mb-0 h4"><?php echo e($countTicket); ?></h3>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 support-ticket-card">
            <div class="support-card-inner d-flex align-items-start gap-3">
                ...
                <div class="support-content flex-1">
                    <span class="text-sm d-block mb-1"><?php echo e(__('Open')); ?></span>
                    <h2 class="h5 mb-0"><?php echo e(__('Ticket')); ?></h2>
                </div>
                <h3 class="mb-0 h4"><?php echo e($countOpenTicket); ?></h3>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 support-ticket-card">
            <div class="support-card-inner d-flex align-items-start gap-3">
                ...
                <div class="support-content flex-1">
                    <span class="text-sm d-block mb-1"><?php echo e(__('On Hold')); ?></span>
                    <h2 class="h5 mb-0"><?php echo e(__('Ticket')); ?></h2>
                </div>
                <h3 class="mb-0 h4"><?php echo e($countonholdTicket); ?></h3>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 support-ticket-card">
            <div class="support-card-inner d-flex align-items-start gap-3">
                ...
                <div class="support-content flex-1">
                    <span class="text-sm d-block mb-1"><?php echo e(__('Close')); ?></span>
                    <h2 class="h5 mb-0"><?php echo e(__('Ticket')); ?></h2>
                </div>
                <h3 class="mb-0 h4"><?php echo e($countCloseTicket); ?></h3>
            </div>
        </div>
    </div>
                                    ...
                                    <tr>
                                                        ...
                                                        <img alt=""
                                                            ...
                                                            <?php if(
                                                                !empty($support->createdBy) &&
                                                                    ...
                                                                    file_exists('storage/uploads/avatar/' . $support->createdBy->avatar)): ?> src="<?php echo e(asset(Storage::url('uploads/avatar')) . '/' . $support->createdBy->avatar); ?>" <?php else: ?>  src="<?php echo e(asset(Storage::url('uploads/avatar')) . '/avatar.png'); ?>" <?php endif; ?>>
                                            ...
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <a href="<?php echo e(route('support.reply', \Crypt::encrypt($support->id))); ?>"
                                                        class="name h6 mb-2 d-block text-sm"><?php echo e($support->subject); ?></a>
                                                    <?php if($support->priority == 0): ?>
                                                        <span data-toggle="tooltip" data-title="<?php echo e(__('Priority')); ?>"
                                                            class="text-capitalize status_badge badge bg-primary p-2 px-3 rounded">
                                                            <?php echo e(__(\App\Models\Support::$priority[$support->priority])); ?></span>
                                        ...
                                        <td>
                                            <?php if(!empty($support->category)): ?>
                                                <span class="badge p-2 px-3 rounded text-white"
                                                    style="background-color: <?php echo e($support->category->color); ?>;">
                                        ...
                                        <td>
                                            <?php if(!empty($support->attachment)): ?>
                                                <a class="bg-primary ms-2 btn btn-sm align-items-center"
                                                    href="<?php echo e($supportpath . '/' . $support->attachment); ?>" download=""
                                                ...
                                                <a href="<?php echo e($supportpath . '/' . $support->attachment); ?>"
                                                    ...
                                                    data-bs-toggle="tooltip" title="<?php echo e(__('Preview')); ?>">
                                        ...
                                        <td>
                                            <?php if($support->status == 'Open'): ?>
                                                <span
                                                    class="status_badge text-capitalize badge bg-success p-2 px-3 rounded"><?php echo e(__(\App\Models\Support::$status[$support->status])); ?></span>
                                            <?php elseif($support->status == 'Close'): ?>
                                                <span
                                                    class="status_badge text-capitalize badge bg-danger p-2 px-3 rounded"><?php echo e(__(\App\Models\Support::$status[$support->status])); ?></span>
                                            <?php elseif($support->status == 'On Hold'): ?>
                                                <span
                                                    class="status_badge text-capitalize badge bg-warning p-2 px-3 rounded"><?php echo e(__(\App\Models\Support::$status[$support->status])); ?></span>
                                            <?php endif; ?>
                                        </td>
