...
<div class="quotation-preview-main"  id="boxes">
    <div class="quotation-header" style="">
        <table class="vertical-align-top">
            <tbody>
                <tr>
                    <td>
                        <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('quotation')); ?></h3>
                    </td>
    ...
    <div class="quotation-body">
        ...
        <table class="quotation-summary" style="border-bottom:1px solid <?php echo e($color); ?>;">
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/quotation/templates/template3.blade.php ENDPATH**/ ?>