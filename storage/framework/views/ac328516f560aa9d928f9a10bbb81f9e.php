...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(AUth::user()->quotationNumberFormat($quotation->quotation_id)); ?></li>
<?php $__env->stopSection(); ?>
                ...
                <div class="card-body">
                    <div class="row mt-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                            <h4 class="invoice-number"><?php echo e(Auth::user()->quotationNumberFormat($quotation->quotation_id)); ?></h4>
                        </div>
                        <div class="col-12">
                            <hr>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/quotation/view.blade.php ENDPATH**/ ?>