...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end me-2">
        <a href="<?php echo e(route('report.profit.loss', 'horizontal')); ?>" class="btn btn-sm bg-light-blue-subtitle" data-bs-toggle="tooltip"
    ...
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-10">
            ...
            <div class="card-header">
                <h5><?php echo e('Profit & Loss of ' . Auth::user()->name . ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>
                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if(
                                                ...
                                                <div
                                                    class="account-inner d-flex align-items-center justify-content-between ps-3">
                                                    <?php if($record['account'] == 'subAccount'): ?>
                                                    <p class="mb-2 ms-md-4"><a
                                                            href="<?php echo e(route('report.ledger', $record['account_id'])); ?>?account=<?php echo e($record['account_id']); ?>"
                                                            class="text-primary"><?php echo e($record['account_name']); ?></a>
                                                    </p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/profit_loss.blade.php ENDPATH**/ ?>