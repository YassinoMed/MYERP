...
<?php endif; ?>
            <select class="form-control select" required="required" id="invoice" name="invoice" disabled>
                ...
                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($key == $creditNote->invoice ? 'selected'  : ''); ?>><?php echo e(\Auth::user()->invoiceNumberFormat($invoice)); ?></option>
...
</script><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/customerCreditNote/edit.blade.php ENDPATH**/ ?>