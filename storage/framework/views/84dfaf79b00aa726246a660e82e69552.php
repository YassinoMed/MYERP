<?php echo e(Form::model($qualityPlan, ['route' => ['production.quality-plans.update', $qualityPlan->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<div class="modal-body"><div class="row">
    ...
    <div class="form-group col-md-3"><?php echo e(Form::label('check_stage', __('Stage'), ['class' => 'form-label'])); ?><?php echo e(Form::select('check_stage', ['incoming'=>__('Incoming'),'in_process'=>__('In Process'),'final'=>__('Final')], null, ['class' => 'form-control'])); ?></div>
    <div class="form-group col-md-3"><?php echo e(Form::label('status', __('Status'), ['class' => 'form-label'])); ?><?php echo e(Form::select('status', ['active'=>__('Active'),'inactive'=>__('Inactive')], null, ['class' => 'form-control'])); ?></div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/production/quality_plans/edit.blade.php ENDPATH**/ ?>