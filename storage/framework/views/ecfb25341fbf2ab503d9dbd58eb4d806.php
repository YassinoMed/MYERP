                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($estimate->status == 0): ?>
                                            <span class="badge status_badge badge-pill badge-primary"><?php echo e(__(\App\Models\Estimation::$statues[$estimate->status])); ?></span>
                                        <?php elseif($estimate->status == 1): ?>
                                            <span class="badge status_badge badge-pill badge-danger"><?php echo e(__(\App\Models\Estimation::$statues[$estimate->status])); ?></span>
                                        <?php elseif($estimate->status == 2): ?>
                                            <span class="badge status_badge badge-pill badge-warning"><?php echo e(__(\App\Models\Estimation::$statues[$estimate->status])); ?></span>
                                        <?php elseif($estimate->status == 3): ?>
                                            <span class="badge status_badge badge-pill badge-success"><?php echo e(__(\App\Models\Estimation::$statues[$estimate->status])); ?></span>
                                        <?php elseif($estimate->status == 4): ?>
                                            <span class="badge status_badge badge-pill badge-info"><?php echo e(__(\App\Models\Estimation::$statues[$estimate->status])); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <?php if(Auth::user()->type != 'client'): ?>
                                        <td class="Action">
