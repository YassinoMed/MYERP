...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        (function () {
            var mainRow = document.getElementById('project-dashboard-main-row');
...
<?php $__env->startSection('page-subtitle'); ?>
    <?php echo e(__('Monitor delivery workload, task throughput and pending actions without losing sight of cross-team priorities.')); ?>
...
<div class="row mb-4 gy-3">
    ...
    <div class="row" id="project-dashboard-main-row">
        <div class="col-lg-4 mb-4 dashboard-widget" data-widget="project_status">
        ...
        <div class="col-lg-8 dashboard-widget" data-widget="tasks_overview">
            <div class="card">
                <div class="card-header">
        ...
        <div class="col-lg-6 dashboard-widget" data-widget="top_due_projects">
            <div class="card">
                <div class="card-header">
        ...
        <div class="col-md-6 dashboard-widget" data-widget="timesheet_logged">
            <div class="card">
                <div class="card-header">
        ...
        <div class="col-md-12 dashboard-widget" data-widget="top_due_tasks">
            <div class="card">
                <div class="card-header">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>