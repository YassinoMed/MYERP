...
<?php $__env->startSection('action-btn'); ?>
    ...
    <div class="float-end me-2">
        <a href="<?php echo e(route('report.profit.loss', 'vertical')); ?>" class="btn btn-sm bg-light-blue-subtitle" data-bs-toggle="tooltip"
    ...
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h5><?php echo e('Profit & Loss ' . Auth::user()->name . ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/profit_loss_horizontal.blade.php ENDPATH**/ ?>