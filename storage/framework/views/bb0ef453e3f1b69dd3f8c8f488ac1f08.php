...
<div class="invoice-preview-main"  id="boxes">
    <div class="invoice-header" style="">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('INVOICE')); ?></h3>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/invoice/templates/template3.blade.php ENDPATH**/ ?>