...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        (function () {
            var mainRow = document.getElementById('pos-dashboard-main-row');
...
<?php $__env->startSection('content'); ?>
    <div class="row gy-4" id="pos-dashboard-main-row">
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 pos-dash-card dashboard-widget" data-widget="pos-monthly-pos">
            <div class="pos-card-inner card mb-0 d-flex flex-column justify-content-between">
                ...
                <div class="pos-info-wrp d-flex align-items-center gap-2 mb-3 justify-content-between">
                    ...
                    <div class="pos-price d-flex gap-2 align-items-center text-center">
                        ...
                        <h3 class="mb-0"><?php echo e($pos_data['monthlyPosAmount']); ?></h3>
                    </div>
                </div>
                <div class="pos-info">
                    <h2 class="h4 m-0">
        ...
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 pos-dash-card dashboard-widget" data-widget="pos-total-pos">
            <div class="pos-card-inner card mb-0 d-flex flex-column justify-content-between">
                <svg class="bottom-svg" width="120" height="70" viewBox="0 0 135 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M74.7692 35C27.8769 35 5.38462 65 0 80H135.692V0C134.923 11.6667 121.662 35 74.7692 35Z" fill="#FF3A6E"></path>
                </svg>
                <div class="pos-info-wrp d-flex align-items-center gap-2 mb-3 justify-content-between">
                    ...
                    <div class="pos-price d-flex gap-2 align-items-center text-center">
                        <span><?php echo e(__('total :')); ?></span>
                        <h3 class="mb-0"><?php echo e($pos_data['totalPosAmount']); ?></h3>
                    </div>
                </div>
                <div class="pos-info">
                    <h2 class="h4 m-0">
                        <a href="<?php echo e(route('pos.report')); ?>" class="dashboard-link"><?php echo e(__('POS Amount')); ?></a>
                    </h2>
                </div>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 pos-dash-card dashboard-widget" data-widget="pos-monthly-purchase">
            <div class="pos-card-inner card mb-0 d-flex flex-column justify-content-between">
                <svg class="bottom-svg" width="120" height="70" viewBox="0 0 135 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M74.7692 35C27.8769 35 5.38462 65 0 80H135.692V0C134.923 11.6667 121.662 35 74.7692 35Z" fill="#FF3A6E"></path>
                </svg>
                <div class="pos-info-wrp d-flex align-items-center gap-2 mb-3 justify-content-between">
                    ...
                    <div class="pos-price d-flex gap-2 align-items-center text-center">
                        <span><?php echo e(__('total :')); ?></span>
                        <h3 class="mb-0"><?php echo e($pos_data['monthlyPurchaseAmount']); ?></h3>
                    </div>
                </div>
                <div class="pos-info">
                    <h2 class="h4 m-0">
                        <a href="<?php echo e(route('purchase.index')); ?>"
                            class="dashboard-link"><?php echo e(__('Purchase Of This Month')); ?></a>
                    </h2>
                </div>
            </div>
        </div>
        <div class="col-xxl-3 col-xl-4 col-sm-6 col-12 pos-dash-card dashboard-widget" data-widget="pos-total-purchase">
            <div class="pos-card-inner card mb-0 d-flex flex-column justify-content-between">
                <svg class="bottom-svg" width="120" height="70" viewBox="0 0 135 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M74.7692 35C27.8769 35 5.38462 65 0 80H135.692V0C134.923 11.6667 121.662 35 74.7692 35Z" fill="#FF3A6E"></path>
                </svg>
                <div class="pos-info-wrp d-flex align-items-center gap-2 mb-3 justify-content-between">
                    ...
                    <div class="pos-price d-flex gap-2 align-items-center text-center">
                        <span><?php echo e(__('total :')); ?></span>
                        <h3 class="mb-0"><?php echo e($pos_data['totalPurchaseAmount']); ?></h3>
                    </div>
                </div>
                <div class="pos-info">
                    <h2 class="h4 m-0">
        ...
        <div class="col-12 dashboard-widget" data-widget="pos-purchase-vs-pos">
            <div class="card">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/dashboard/pos-dashboard.blade.php ENDPATH**/ ?>