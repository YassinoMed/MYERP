        ...
        function getProduct(bid) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#product_div").html('');
                    $('#product_div').append('<label for="product_id" class="form-label"><?php echo e(__('Product')); ?></label><span class="text-danger">*</span>');
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::open(array('route'=>'pos.receipt','method'=>'post', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/pos/print.blade.php ENDPATH**/ ?>