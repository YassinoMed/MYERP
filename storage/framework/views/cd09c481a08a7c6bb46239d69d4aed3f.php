...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
                ...
                hide: function (deleteElement) {
                    ...
                    if (confirm('Are you sure you want to delete this element?')) {
                        ...
                        if (id != undefined && id != null && id != '') {
                            $.ajax({
                                url: '<?php echo e(route('expense.product.destroy')); ?>',
                                type: 'POST',
                                headers: {
        ...
        var bill_id = '<?php echo e($expense->id); ?>';
        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('expense.items')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($expense, array('route' => array('expense.update', $expense->id), 'method' => 'PUT','class'=>'w-100', 'class'=>'needs-validation', 'novalidate'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="col">
                                <div class="form-check form-check-inline form-group">
                                    <input type="radio" id="employee_radio" value="employee" name="type" class="form-check-input" <?php echo e($expense->user_type == 'employee' ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="employee"><?php echo e(__('Employee')); ?></label>
                                </div>
                                <div class="form-check form-check-inline form-group">
                                    <input type="radio" id="customer_radio" value="customer" name="type" class="form-check-input" <?php echo e($expense->user_type == 'customer' ? 'checked' : ''); ?> >
                                    <label class="form-check-label" for="customer"><?php echo e(__('Customer')); ?></label>
                                </div>

                                <div class="form-check form-check-inline form-group">
                                    <input type="radio" id="vendor_radio" value="vendor" name="type" class="form-check-input" <?php echo e($expense->user_type == 'vendor' ? 'checked' : ''); ?>>
                            ...
                            <div class="col employee">
                                <div class="form-group" id="employee-box">
                                    ...
                                    <?php echo e(Form::select('employee_id', $employees,$expense->vender_id, array('class' => 'form-control select','id'=>'employee','data-url'=>route('expense.employee')))); ?>
                            ...
                            <div class="col customer d-none">
                                <div class="form-group" id="customer-box">
                                    ...
                                    <?php echo e(Form::select('customer_id', $customers,$expense->vender_id, array('class' => 'form-control select','id'=>'customer','data-url'=>route('expense.customer')))); ?>
                            ...
                            <div class="col vendor d-none">
                                <div class="form-group" id="vender-box">
                                    ...
                                    <?php echo e(Form::select('vender_id', $venders,$expense->vender_id, array('class' => 'form-control select','id'=>'vender','data-url'=>route('expense.vender')))); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('bill_date', __('Payment Date'),['class'=>'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
...
<?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select" name="account_id" required>
                                            <?php $__currentLoopData = $bank_Account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php if(isset($bankAccount) && $bankAccount->id == $key): ?> selected <?php endif; ?>><?php echo e(__($account)); ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('bill_number', __('Expense Number'),['class'=>'form-label'])); ?>

                                        <input type="text" class="form-control" value="<?php echo e($expense_number); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0">
                                        <?php echo e(Form::select('items', $product_services,null, array('class' => 'form-control select item','data-url'=>route('expense.product'), 'required' => 'required'))); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/expense/edit.blade.php ENDPATH**/ ?>