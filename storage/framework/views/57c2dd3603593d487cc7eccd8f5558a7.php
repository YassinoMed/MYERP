...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-10">
            ...
            <div class="card-body <?php echo e($view == 'collapse' ? 'collapse-view' : ''); ?> overflow-auto">
                <div class="account-table-inner">
                    <div class="account-title d-flex align-items-center justify-content-between border-top border-bottom py-2">
                        ...
                        <h6 class="mb-0 text-end"><?php echo e(__('Debit')); ?></h6>
                        ...
                        <div class="account-main-inner border-bottom py-2">
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php elseif($record['account'] == 'subAccount'): ?>
                                        <div class="account-inner d-flex align-items-center justify-content-between ps-3 ms-3">
                                            <p class="mb-2 ms-md-3"><a
                                                    href="<?php echo e(route('report.ledger', $record['account_id'])); ?>?account=<?php echo e($record['account_id']); ?>"
                                                    class="text-primary"><?php echo e($record['account_name']); ?></a>
                                            </p>
                                            <p class="mb-2 text-center me-3"><?php echo e($record['account_code']); ?></p>
                    ...
                    <?php if($totalAccounts != []): ?>
                        <div
                            ...
                            <h6 class="fw-bold mb-0 text-end ms-4"><?php echo e(\Auth::user()->priceFormat($totalDebit)); ?></h6>
                            <h6 class="fw-bold mb-0 text-end"><?php echo e(\Auth::user()->priceFormat($totalCredit)); ?></h6>

                        </div>
                    <?php else: ?>
                        <div class="mt-5">
                                <h6 class="fw-bold mb-0 text-center"><?php echo e('!! No Data Found !!'); ?></h6>
                        </div>
                    <?php endif; ?>
                </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/doubleentry_report/trial_balance.blade.php ENDPATH**/ ?>