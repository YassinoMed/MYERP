<?php echo e(Form::open(array('url' => 'warehouse', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::textarea('address',null,array('class'=>'form-control','rows'=>3 ,'required'=>'required', 'placeholder' => __('Enter Address')))); ?>
...
<?php endif; ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('city_zip',null,array('class'=>'form-control', 'placeholder' => __('Enter Zip')))); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/warehouse/create.blade.php ENDPATH**/ ?>