                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="#" class="btn btn-sm btn-primary me-1  " onclick="document.getElementById('report_leave').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
                        ...
                        <div class="card report-card mb-0">
                            <div class="card-body d-flex align-items-center gap-3">
                                ...
                                <div class="report-info">
                                    ...
                                    <p class="text-muted mb-0"><?php echo e($filterYear['type'] . ' ' . __('Leave Summary')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 leave-card">
                        <div class="leave-card-inner d-flex align-items-center gap-3">
                            ...
                            <div class="leave-info">
                                <h5 class="mb-2"><?php echo e(__('Approved Leaves')); ?></h5>
                                <span class="h3"><?php echo e($filter['totalApproved']); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 leave-card">
                        <div class="leave-card-inner d-flex align-items-center gap-3">
                            ...
                            <div class="leave-info">
                                <h5 class="mb-2"><?php echo e(__('Rejected Leave')); ?></h5>
                                <span class="h3"><?php echo e($filter['totalReject']); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 leave-card">
                        <div class="leave-card-inner d-flex align-items-center gap-3">
                            ...
                            <div class="leave-info">
                                <h5 class="mb-2"><?php echo e(__('Pending Leaves')); ?></h5>
                                <span class="h3"><?php echo e($filter['totalPending']); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/leave.blade.php ENDPATH**/ ?>