                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="<?php echo e(route('report.daily.pos')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Daily Pos Report')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/daily_pos.blade.php ENDPATH**/ ?>