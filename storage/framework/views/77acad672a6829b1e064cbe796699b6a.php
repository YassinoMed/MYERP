            ...
            <div class="row">
                ...
                <div class="col-xl-9 setting-menu-div">
                    ...
                    <div id="brand-settings" class="card">
                        ...
                        <?php echo e(Form::model($settings, ['url' => 'systems', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'data-ux-submit-guard' => '1', 'data-ux-dirty' => '1', 'data-autosave' => '1'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row row-gap-1 mb-3">
                                        ...
                                        <div class="card h-100 mb-0">
                                            <div class="card-header p-3">
                                                <h6 class="mb-0 d-flex align-items-center gap-2">
                                                    <i class="ti ti-align-right"></i><?php echo e(__('Landing Page')); ?>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-12">
                                        <div class="card h-100 mb-0">
                                            <div class="card-header p-3">
                                                <h6 class="mb-0 d-flex align-items-center gap-2">
                                                    <i class="ti ti-align-right"></i><?php echo e(__('Enable Sign-Up Page')); ?>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-12">
                                        <div class="card h-100 mb-0">
                                            <div class="card-header p-3">
                                                <h6 class="mb-0 d-flex align-items-center gap-2">
                                                    <i class="ti ti-align-right"></i><?php echo e(__('Email Verification')); ?>
                                        ...
                                        <div class="col-xxl-4 col-sm-6 col-12">
                                            <div class="card h-100 mb-0">
                                                <div class="card-header p-3">
                                                    <h6 class="mb-0 d-flex align-items-center gap-2">
                                                        <i
                                                            data-feather="credit-card"></i><?php echo e(__('Primary color settings')); ?>
                                        ...
                                        <div class="col-xxl-3 col-sm-6 col-12">
                                            <div class="card h-100 mb-0">
                                                ...
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="form-check form-switch d-flex gap-2 flex-column p-0 mt-3">
                                                        <label class="form-check-label f-w-600 pl-1"
                                                            for="cust-darklayout-auto"><?php echo e(__('Auto Dark Mode')); ?></label>
                                                        <input type="checkbox" class="form-check-input mx-0"
                                                            id="cust-darklayout-auto"
                                                            name="cust_darklayout_auto"<?php echo e(!empty($settings['cust_darklayout_auto']) && $settings['cust_darklayout_auto'] == 'on' ? 'checked' : ''); ?> />
                                                    </div>
                        ...
                        <?php echo e(Form::close()); ?>
                         ...
                         <div class="col-12">
                                        <div class="card h-100 mb-0">
                                            <div class="card-header p-3">
                                                <h6 class="mb-0 d-flex align-items-center gap-2">
                                                    <i data-feather="sliders"></i><?php echo e(__('Module Colors')); ?>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="row row-gap-2">
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-default"><?php echo e(__('Default')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-default" name="module_color_default"
                                                            value="<?php echo e(!empty($settings['module_color_default']) ? $settings['module_color_default'] : '#6FD943'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-account"><?php echo e(__('Accounting')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-account" name="module_color_account"
                                                            value="<?php echo e(!empty($settings['module_color_account']) ? $settings['module_color_account'] : '#4b7bec'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-crm"><?php echo e(__('CRM')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-crm" name="module_color_crm"
                                                            value="<?php echo e(!empty($settings['module_color_crm']) ? $settings['module_color_crm'] : '#20bf6b'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-hrm"><?php echo e(__('HRM')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-hrm" name="module_color_hrm"
                                                            value="<?php echo e(!empty($settings['module_color_hrm']) ? $settings['module_color_hrm'] : '#eb3b5a'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-project"><?php echo e(__('Projects')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-project" name="module_color_project"
                                                            value="<?php echo e(!empty($settings['module_color_project']) ? $settings['module_color_project'] : '#f7b731'); ?>">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label" for="module-color-pos"><?php echo e(__('POS')); ?></label>
                                                        <input type="color" class="form-control form-control-color"
                                                            id="module-color-pos" name="module_color_pos"
                                                            value="<?php echo e(!empty($settings['module_color_pos']) ? $settings['module_color_pos'] : '#2d98da'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div id="email-settings" class="card">
                        <div class="card-header p-3">
                            <h5 class="mb-1"><?php echo e(__('Email Settings')); ?></h5>
                            <small
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer p-3 d-flex justify-content-end">
                                <div class="form-group mb-0">
                                    <a href="#" data-url="<?php echo e(route('test.mail')); ?>"
                                        data-title="<?php echo e(__('Send Test Mail')); ?>" class="btn btn-primary send_email me-1">
                    ...
                    <div class="card" id="payment-settings">
                        <div class="card-header p-3">
                            <h5 class="mb-1"><?php echo e('Payment Settings'); ?></h5>
                        ...
                        <?php echo e(Form::open(['route' => 'payment.settings', 'method' => 'post', 'class' => 'mb-0'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div class="me-2">
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label
                                                                                            class="form-check-labe text-dark <?php echo e(isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == 'sandbox' ? 'active' : ''); ?>">
                                                                                            <input type="radio"
                                                                                                name="aamarpay_mode"
                                                                                                value="sandbox"
                                                                                                class="form-check-input"
                                                                                                <?php echo e((isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == '') || (isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>><?php echo e(__('Sandbox')); ?>
                                                                            ...
                                                                            <div class="me-2">
                                                                                <div class="border card p-3">
                                                                                    <div class="form-check">
                                                                                        <label
                                                                                            class="form-check-labe text-dark <?php echo e(isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == 'live' ? 'active' : ''); ?>">
                                                                                            <input type="radio"
                                                                                                name="aamarpay_mode"
                                                                                                value="live"
                                                                                                class="form-check-input"
                                                                                                <?php echo e(isset($admin_payment_setting['aamarpay_mode']) && $admin_payment_setting['aamarpay_mode'] == 'live' ? 'checked="checked"' : ''); ?>><?php echo e(__('Live')); ?>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($admin_payment_setting['easebuzz_payment_is_on']) && $admin_payment_setting['easebuzz_payment_is_on'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </h2>
                    ...
                    <div id="pusher-settings" class="card">
                        ...
                        <?php echo e(Form::model($settings, ['route' => 'pusher.setting', 'class' => 'mb-0', 'method' => 'post'])); ?>
                            ...
                            <div class="row row-gap-1">
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(Form::text('pusher_app_id', null, ['class' => 'form-control font-style', 'placeholder' => __('Pusher App Id')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(Form::text('pusher_app_key', null, ['class' => 'form-control font-style', 'placeholder' => __('Pusher App Key')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(Form::text('pusher_app_secret', null, ['class' => 'form-control font-style', 'placeholder' => __('Pusher App Secret')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(Form::text('pusher_app_cluster', null, ['class' => 'form-control font-style', 'placeholder' => __('Pusher App Cluster')])); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="storage-settings" class="card mb-3">
                        <?php echo e(Form::open(['route' => 'storage.setting.store', 'class' => 'mb-0','enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex mb-3">
                                ...
                                <div class="s3-setting row row-gap-1 <?php echo e($setting['storage_setting'] == 's3' ? ' ' : 'd-none'); ?>">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-0">
                    ...
                    <div id="seo-settings" class="card">
                        ...
                        <?php echo e(Form::open(['url' => route('seo.settings.store'), 'method' => 'post','class' => 'mb-0', 'enctype' => 'multipart/form-data'])); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card" id="cookie-settings">
                        ...
                        <?php echo e(Form::model($settings, ['route' => 'cookie.setting','class' => 'mb-0', 'method' => 'post'])); ?>
                        ...
                        <div
                            class="card-body p-3 cookieDiv <?php echo e($settings['enable_cookie'] == 'off' ? 'disabledCookie ' : ''); ?>">
                            <?php
                                $settings = \App\Models\Utility::settings();
                            ?>
                            <div class="row">
                            ...
                            <div class="row row-gap-1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <?php echo e(Form::text('strictly_cookie_title', null, ['class' => 'form-control cookie_setting', 'placeholder' => __('Strictly Cookie Title')])); ?>
                    ...
                    <div class="card" id="cache-settings">
                        ...
                        <form method="POST" action="<?php echo e(route('cache.settings.store')); ?>" accept-charset="UTF-8" class="mb-0">
                            <?php echo csrf_field(); ?>
                            <div class="card-body p-3">
                                <div class="row">
                    ...
                    <div id="chat-gpt-settings" class="card">
                        ...
                        <?php echo e(Form::model($settings, ['route' => 'chatgpt.settings','class' => 'mb-0', 'method' => 'post'])); ?>
                        ...
                        <div class="card-body p-3">
                            <div class="row row-gap-1">
                                ...
                                <div class="form-group mb-0 col-md-12">
                                    ...
                                    <?php echo e(Form::select('chat_gpt_model', $ai_models, isset($settings['chat_gpt_model']) ? $settings['chat_gpt_model'] : '', ['class' => 'form-control', 'placeholder' => __('Select Chat GPT Model'), 'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/settings/index.blade.php ENDPATH**/ ?>