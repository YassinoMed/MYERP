...
<?php $__env->startSection('action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create holiday')): ?>
        <div class="float-end d-flex">
            <a href="<?php echo e(route('holiday.index')); ?>" class="btn btn-sm bg-light-blue-subtitle me-2" data-bs-toggle="tooltip" title="<?php echo e(__('List View')); ?>" data-original-title="<?php echo e(__('List View')); ?>">
    ...
    <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <div class="row">
                                            <div class="col-auto mt-4">
                                                <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('holiday_filter').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 mb-4">
                <div class="card h-100 mb-0">
                    <div class="card-header">
                        <h5 class="mb-0"><?php echo e(__('Holiday List')); ?></h5>
                    </div>
                        ...
                        <div class="event-wrp holiday-wrp">
                                    ...
                                    <div class="event-item d-flex align-items-center">
                                        <div class="event-content flex-1">
                                            ...
                                            <div class="date-wrp d-flex flex-wrap align-items-center">
                                                <div class="date">
                                                    <span
                                                        class="f-w-600"><?php echo e(__('Start Date : ')); ?></span><?php echo e(\Auth::user()->dateFormat($holiday->date)); ?>

                                                </div>
                                                <div class="date">
                                                    <span
                                                        class="f-w-600"><?php echo e(__('End Date : ')); ?></span><?php echo e(\Auth::user()->dateFormat($holiday->end_date)); ?>
                                        ...
                                        <div class="action-btns d-flex flex-column gap-2">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit interview schedule')): ?>
                                                <a href="#" data-url="<?php echo e(route('holiday.edit', $holiday->id)); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete interview schedule')): ?>
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-confirm-yes="document.getElementById('delete-form-<?php echo e($holiday->id); ?>').submit();"><i
                            ...
                            <?php else: ?>
                                <div class="text-center">
                                    <h6><?php echo e(__('There is no holiday in this month')); ?></h6>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/holiday/calender.blade.php ENDPATH**/ ?>