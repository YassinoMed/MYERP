                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $allowances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allownace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php else: ?>
                                                                    <td><?php echo e(($allownace->amount)); ?>% (<?php echo e(\Auth::user()->priceFormat($empallow)); ?>)</td>
                                                                <?php endif; ?>
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php else: ?>
                                                                    <td><?php echo e(($commission->amount)); ?>% (<?php echo e(\Auth::user()->priceFormat($empcomm)); ?>)</td>
                                                                <?php endif; ?>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php else: ?>
                                                                    <td><?php echo e(($loan->amount)); ?>%(<?php echo e(\Auth::user()->priceFormat($emploan)); ?>)</td>
                                                                <?php endif; ?>
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $saturation_deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php else: ?>
                                                                    <td><?php echo e(($deduction->amount)); ?>% (<?php echo e(\Auth::user()->priceFormat($empdeduction)); ?>)</td>
                                                                <?php endif; ?>
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        <?php $__currentLoopData = $other_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php else: ?>
                                                                    <td><?php echo e(($payment->amount)); ?>% (<?php echo e(\Auth::user()->priceFormat($emppayment)); ?>)</td>
                                                                <?php endif; ?>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/payslip/show.blade.php ENDPATH**/ ?>