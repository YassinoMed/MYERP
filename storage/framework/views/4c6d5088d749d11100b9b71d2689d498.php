<div class="col-form-label">
    <div class="row px-3">
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-2"><?php echo e(__('Employee')); ?></h6>
        ...
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-2"><?php echo e(__('Basic Salary')); ?></h6>
            <h6 class="emp-title black-text"><?php echo e(\Auth::user()->priceFormat( $payslip->basic_salary)); ?></h6>
        </div>
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-2"><?php echo e(__('Payroll Month')); ?></h6>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $allowances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allownace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php echo Form::text('allowance[]', $allownace->amount, ['class' => 'form-control', 'placeholder'=>__($allownace->title)]); ?>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php echo Form::text('commission[]', $commission->amount, ['class' => 'form-control', 'placeholder'=>__($commission->title)]); ?>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php echo Form::text('loan[]', $loan->amount, ['class' => 'form-control', 'placeholder'=>__($loan->title)]); ?>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $saturation_deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php echo Form::text('saturation_deductions[]', $deduction->amount, ['class' => 'form-control', 'placeholder'=>__($deduction->title)]); ?>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $other_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php echo Form::text('other_payment[]', $payment->amount, ['class' => 'form-control', 'placeholder'=>__($payment->title)]); ?>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        <?php $__currentLoopData = $overtimes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $overtime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <?php echo Form::text('rate[]', $overtime->rate, ['class' => 'form-control', 'placeholder'=>__($overtime->title.' '.__('Rate'))]); ?>

                                                <?php echo Form::hidden('rate_id[]', $overtime->id, ['class' => 'form-control']); ?>

                                            </div>
                                            <div class="col-md-6 form-group">
                                                <?php echo Form::label('hours',$overtime->title.' '.__('Hours'),['class'=>'col-form-label', 'placeholder'=>__($overtime->title.' '.__('Hours'))]); ?>

                                                <?php echo Form::text('hours[]', $overtime->hours, ['class' => 'form-control']); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/payslip/salaryEdit.blade.php ENDPATH**/ ?>