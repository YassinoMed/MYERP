                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($payslip->status == 1): ?>
                                                        <div class="badge status_badge badge-success"><a class="text-white"><?php echo e(__('Paid')); ?></a></div> <?php else: ?>
                                                        <div class="badge status_badge badge-danger"><a class="text-white"><?php echo e(__('Unpaid')); ?></a></div>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/payslip/employeepayslip.blade.php ENDPATH**/ ?>