<?php echo e(Form::model($vender,array('route' => array('vender.update', $vender->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php $component = App\View\Components\Mobile::resolve(['label' => ''.e(__('Contact')).'','name' => 'contact','value' => ''.e($vender->contact).'','required' => true,'placeholder' => 'Enter Contact'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('shipping_zip',null,array('class'=>'form-control', 'placeholder'=>__('Enter Zip')))); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/vender/edit.blade.php ENDPATH**/ ?>