    ...
    <script>
        (function () {
            ...
            drake.on('drop', function () {
                ...
                $.ajax({
                    url: '<?php echo e(route('form.field.order', $formBuilder->id)); ?>',
                    type: 'POST',
                    data: {
                        order: order,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/form_builder/show.blade.php ENDPATH**/ ?>