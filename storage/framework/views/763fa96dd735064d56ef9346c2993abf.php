                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        <a href="#" class="btn btn-sm btn-primary me-1" onclick="document.getElementById('report_monthly_attendance').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
                ...
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Attendance Summary')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card report-card mb-0 h-100">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <p class="text-muted mb-0"><?php echo e($data['branch']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card report-card mb-0 h-100">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                ...
                                <p class="text-muted mb-0"><?php echo e($data['department']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e($data['curMonth']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info w-100 flex-1">
                            <h5 class="mb-1"><?php echo e(__('Attendance')); ?></h5>
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                <p class="text-muted mb-0"><?php echo e(__('Total present')); ?>: 24</p>
                                <p class="text-muted mb-0"><?php echo e(__('Total leave')); ?> : 20</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Overtime')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('Total overtime in hours')); ?> : <?php echo e(number_format(25.55,2)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Early leave')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('Total early leave in hours')); ?> : <?php echo e(number_format(10.50,2)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-xl-3 mb-4">
                <div class="card report-card mb-0 h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            <h5 class="mb-1"><?php echo e(__('Employee late')); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(__('Total late in hours')); ?> : <?php echo e(number_format(7.30,2)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <?php $__currentLoopData = $employeesAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $attendance['status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td>
                                                <?php if($status=='P'): ?>
                                                    <i class="badge bg-success p-2 "><?php echo e(__('P')); ?></i>
                                                <?php elseif($status=='A'): ?>
                                                    <i class="badge bg-danger p-2 "><?php echo e(__('A')); ?></i>
                                                <?php endif; ?>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/report/monthlyAttendance.blade.php ENDPATH**/ ?>