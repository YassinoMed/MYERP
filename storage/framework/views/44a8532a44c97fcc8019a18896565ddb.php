<?php echo e(Form::model($bom, ['route' => ['production.boms.update', $bom->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('code', null, ['class' => 'form-control', 'placeholder' => __('Enter Code')])); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('version', __('Active Version'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::text('version', $bom->activeVersion?->version, ['class' => 'form-control', 'placeholder' => __('Enter Version')])); ?>
                    ...
                    <tbody>
                        ...
                        <?php if($lines->count() > 0): ?>
                            <?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <?php echo e(Form::select('components[]', $components, $line->component_product_id, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Select Component')])); ?>

                                    </td>
                                    <td>
                                        <?php echo e(Form::number('quantities[]', $line->quantity, ['class' => 'form-control', 'required' => 'required', 'step' => '0.0001', 'min' => 0.0001])); ?>

                                    </td>
                                    <td>
                                        <?php echo e(Form::number('scrap_percents[]', $line->scrap_percent, ['class' => 'form-control', 'step' => '0.01', 'min' => 0, 'max' => 100])); ?>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/production/boms/edit.blade.php ENDPATH**/ ?>