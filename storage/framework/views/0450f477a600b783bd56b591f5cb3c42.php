    ...
    <div class="row">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete job application')): ?>
                            <li class="list-inline-item float-end m-0">
                                ...
                                <a href="#"
                                    ...
                                    data-confirm-yes="document.getElementById('archive-form-<?php echo e($jobApplication->id); ?>').submit();">
                            ...
                            <?php if($jobApplication->is_archive == 0): ?>
                                <li class="list-inline-item">
                                    ...
                                    <a href="#"
                                        ...
                                        data-confirm-yes="document.getElementById('delete-form-<?php echo e($jobApplication->id); ?>').submit();">
                                        <span
                                            class="badge badge-pill bg-danger p-2 px-3 rounded"><?php echo e(__('Delete')); ?></span></a>
                                    <?php echo Form::close(); ?>
                    ...
                    <h5 class="h4">
                        <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                            ...
                            <div>
                                ...
                                ?>
                                <a href="<?php echo e(!empty($jobApplication->profile) ? $profiles . $jobApplication->profile : $logo . 'avatar.png'); ?>"
                                    class=" avatar-sm">
                            ...
                            <div class="flex-fill ms-3">
                                <div class="h6 mb-0"> <?php echo e($jobApplication->name); ?></div>
                                <p class= "lh-140 mb-0">
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100 mb-0">
                <div class="card-header d-flex align-items-center gap-3 flex-wrap justify-content-between">
                    <h5><?php echo e(__('Basic Information')); ?></h5>

                    <a href="#" data-url="<?php echo e(route('job.on.board.create', $jobApplication->id)); ?>"
                        data-title="<?php echo e(__('Add to Job OnBoard')); ?>" data-ajax-popup="true"
                ...
                <div class="card-body">
                    <dl class="row">
                        <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Phone')); ?></span></dt>
                        <dd class="col-sm-9"><span><?php echo e($jobApplication->phone); ?></span></dd>
                        <?php if(!empty($jobApplication->dob)): ?>
                            <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('DOB')); ?></span></dt>
                            <dd class="col-sm-9"><span><?php echo e(\Auth::user()->dateFormat($jobApplication->dob)); ?></span></dd>
                        <?php endif; ?>
                        <?php if(!empty($jobApplication->gender)): ?>
                            <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Gender')); ?></span></dt>
                            <dd class="col-sm-9"><span><?php echo e($jobApplication->gender); ?></span></dd>
                        <?php endif; ?>
                        <?php if(!empty($jobApplication->country)): ?>
                            <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Country')); ?></span></dt>
                            <dd class="col-sm-9"><span><?php echo e($jobApplication->country); ?></span></dd>
                        <?php endif; ?>
                        <?php if(!empty($jobApplication->state)): ?>
                            <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('State')); ?></span></dt>
                            <dd class="col-sm-9"><span><?php echo e($jobApplication->state); ?></span></dd>
                        <?php endif; ?>
                        <?php if(!empty($jobApplication->city)): ?>
                            <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('City')); ?></span></dt>
                            <dd class="col-sm-9"><span><?php echo e($jobApplication->city); ?></span></dd>
                        <?php endif; ?>

                        <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Applied For')); ?></span></dt>
                        <dd class="col-sm-9">
                            <span><?php echo e(!empty($jobApplication->jobs) ? $jobApplication->jobs->title : '-'); ?></span>
                        </dd>

                        <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Applied at')); ?></span></dt>
                        <dd class="col-sm-9"><span><?php echo e(\Auth::user()->dateFormat($jobApplication->created_at)); ?></span></dd>
                        <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('CV / Resume')); ?></span></dt>
                        <dd class="col-sm-9">
                            <?php if(!empty($jobApplication->resume)): ?>
                                <span class=" action-btn ms-2 ">
                                    <a href="<?php echo e(asset(Storage::url('uploads/job/resume')) . '/' . $jobApplication->resume); ?>"
                                        ...
                                        data-bs-original-title="<?php echo e(_('Download')); ?>"><i
                        ...
                        <dt class="col-sm-3"><span class="h6 mb-0"><?php echo e(__('Cover Letter')); ?></span></dt>
                        <dd class="col-sm-9"><span><?php echo e($jobApplication->cover_letter); ?></span></dd>


                    </dl>
                    <div class='rating-stars text-right'>
                        <ul id='stars' class="mb-0">
                            <li class='star <?php echo e(in_array($jobApplication->rating, [1, 2, 3, 4, 5]) == true ? 'selected' : ''); ?>'
                                data-bs-toggle="tooltip" data-bs-title="Poor" data-value='1'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e(in_array($jobApplication->rating, [2, 3, 4, 5]) == true ? 'selected' : ''); ?>'
                                data-bs-toggle="tooltip" data-bs-title='Fair' data-value='2'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e(in_array($jobApplication->rating, [3, 4, 5]) == true ? 'selected' : ''); ?>'
                                data-bs-toggle="tooltip" data-bs-title='Good' data-value='3'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e(in_array($jobApplication->rating, [4, 5]) == true ? 'selected' : ''); ?>'
                                data-bs-toggle="tooltip" data-bs-title='Excellent' data-value='4'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star <?php echo e(in_array($jobApplication->rating, [5]) == true ? 'selected' : ''); ?>'
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center gap-3 flex-wrap justify-content-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create interview schedule')): ?>
                <a href="#" data-url="<?php echo e(route('interview-schedule.create', $jobApplication->id)); ?>" data-size="lg"
                        ...
                        <?php if(!empty($ans)): ?>
                            <div class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <a href="#!" class="d-block h6 mb-2"><?php echo e($que); ?></a>
            ...
            <div class="row row-gap-1">
                <div class="col-md-6 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($jobApplication->skill); ?>"
                            data-toggle="tags" name="skill" placeholder="<?php echo e(__('Type here....')); ?>" />
                    </div>
                ...
                <div class="col-md-6 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" class="form-control" id="" rows="1"
                            placeholder="<?php echo e(__('Type here....')); ?>"></textarea>
                    </div>
                ...
                <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <a href="#!"
                                    class="d-block h6 mb-2"><?php echo e(!empty($note->noteCreated) ? $note->noteCreated->name : '-'); ?></a>
                                <p class="card-text text-muted mb-0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/jobApplication/show.blade.php ENDPATH**/ ?>