                        ...
                        <div data-v-37eeda86="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e($color); ?>; border-top: 1px solid <?php echo e($color); ?>;">
                                            ...
                                            <div class="d-table-th w-4 text-end"><?php echo e(__('Totals')); ?></div>
                                        </div>
                                                ...
                                                <?php $__currentLoopData = $estimation->getProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="d-table-tr" style="border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div class="d-table-td w-5">
                                                            <pre data-v-f2a183a6=""><?php echo e($usr->priceFormat($item->pivot->price)); ?></pre>
                                                        </div>
                                                        <div class="d-table-td w-5">
                                                            <pre data-v-f2a183a6=""><?php echo e($item->pivot->quantity); ?></pre>
                                                        </div>
                                                        <div class="d-table-td w-4 text-end"><span><?php echo e($usr->priceFormat($item->pivot->price * $item->pivot->quantity)); ?></span></div>
                                                    </div>
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    ...
                                                    <div
                                                        class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal())); ?></div>
                                                </div>
                                                <?php if($estimation->discount): ?>
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                        <div
                                                            class="d-table-value"><?php echo e($usr->priceFormat($estimation->discount)); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($estimation->getTax()): ?>
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">
                                                            <?php echo e($estimation->tax->name); ?> (<?php echo e($estimation->tax->rate); ?>%):
                                                        </div>
                                                        <div class="d-table-value"><?php echo e($usr->priceFormat($estimation->getTax())); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <div class="d-table-summary-item"
                                                    ...
                                                    <div class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH /Users/mohamedyassine/Downloads/Nouveau dossier contenant des éléments 5/erpgosaas-81nulled/codecanyon-33263426-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm/main-file/resources/views/estimations/templates/template2.blade.php ENDPATH**/ ?>